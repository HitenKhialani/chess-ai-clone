    ...
    <main className="min-h-screen krishna-gradient relative overflow-hidden">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div>
            <Card className="krishna-card border-rgb(153, 0, 255)/30 card-shadow text-white purple-glow">
              <CardHeader>
                <CardTitle>Chess Board</CardTitle>
                <CardDescription className="text-rgb(200, 200, 200)">Make moves or upload a PGN to analyze</CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <div className="flex flex-col lg:flex-row justify-center gap-8 mt-4">
              <div className="flex gap-2 justify-center w-full">
                <Button onClick={handleUndo} disabled={moveStack.length === 0} className="krishna-card border-rgb(153, 0, 255)/30 text-white hover:bg-rgb(153, 0, 255)/20">Undo</Button>
                <Button onClick={handleRedo} disabled={redoStack.length === 0} className="krishna-card border-rgb(153, 0, 255)/30 text-white hover:bg-rgb(153, 0, 255)/20">Redo</Button>
                <Button className="bg-gradient-to-r from-rgb(76, 0, 255) to-rgb(153, 0, 255) hover:from-rgb(153, 0, 255) hover:to-rgb(76, 0, 255) text-white btn-glow" onClick={resetAnalysis}>Reset Board</Button>
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <Button
                      className="bg-gradient-to-r from-rgb(76, 0, 255) to-rgb(153, 0, 255) text-white border border-rgb(153, 0, 255)/30 hover:from-rgb(153, 0, 255) hover:to-rgb(76, 0, 255)"
                      variant="outline"
                    >
          ...
          <div className="space-y-6">
            <Card className="card border border-[var(--accent)] shadow-lg text-[var(--primary-text)]">
              <CardHeader>
                <CardTitle>Game Controls</CardTitle>
                <CardDescription className="text-[var(--secondary-text)]">Upload PGN or analyze current position</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  <Textarea
                    ...
                    className="card border border-[var(--accent)] text-[var(--primary-text)] placeholder:text-[var(--secondary-text)]"
                  />
            ...
            <div className="mt-12">
              <h2 className="text-2xl font-semibold mb-6 text-white">Analysis Features</h2>
              <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
                <Card className="krishna-card border-rgb(153, 0, 255)/30 card-shadow text-white purple-glow">
                  <CardHeader>
                    <Brain className="h-8 w-8 mb-2 text-rgb(153, 0, 255)" />
                    <CardTitle>AI Analysis</CardTitle>
                    <CardDescription className="text-rgb(200, 200, 200)">Get instant computer analysis</CardDescription>
                  </CardHeader>
                </Card>
                <Card className="krishna-card border-rgb(153, 0, 255)/30 card-shadow text-white purple-glow">
                  <CardHeader>
                    <TrendingUp className="h-8 w-8 mb-2 text-rgb(153, 0, 255)" />
                    <CardTitle>Statistics</CardTitle>
                    <CardDescription className="text-rgb(200, 200, 200)">View detailed game statistics</CardDescription>
                  </CardHeader>
                </Card>
                <Card className="krishna-card border-rgb(153, 0, 255)/30 card-shadow text-white purple-glow">
                  <CardHeader>
                    <AlertCircle className="h-8 w-8 mb-2 text-rgb(153, 0, 255)" />
                    <CardTitle>Mistakes</CardTitle>
                    <CardDescription className="text-rgb(200, 200, 200)">Find and learn from mistakes</CardDescription>
                  </CardHeader>
                </Card>
              </div>
            </div>
