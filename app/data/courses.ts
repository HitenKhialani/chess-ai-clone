...
export const courses: Course[] = [
  // Beginners Course
  {
    ...
    title: 'Beginners',
    subtitle: '',
    description: 'Master the fundamentals of chess with this comprehensive beginner course. Learn how pieces move, understand chess notation, and grasp the basic rules and objectives of the game. Perfect for those new to chess or looking to strengthen their foundation.',
    difficulty: 'Beginner',
    estimatedTime: '1.5 hours',
    youWillLearn: [
      'How each chess piece moves and captures.',
      'Understanding algebraic notation and chess language.',
      'Basic rules including check, checkmate, and special moves.',
      'Game objectives and winning strategies.'
    ],
    ...
    lessons: [
      {
        ...
        pgn: 'e4 e5 2. Nf3 Nc6 3. Bc4 Bc5 4. Qe2 Qe7 5. O-O O-O',
        writeup: 'Understanding how each piece moves is the foundation of chess. This lesson covers the movement patterns of pawns, knights, bishops, rooks, queens, and kings, including their unique characteristics and capturing methods.'
      },
      {
        title: 'Understanding Chess Notation',
        level: 'Beginner',
        concept: 'Master algebraic notation to read and write chess moves.',
        pgn: 'e4 e5 2. Nf3 Nc6 3. Bc4 Bc5 4. O-O Nf6 5. d3 d6',
        writeup: 'Chess notation is the language of chess. Learn to read and write moves using algebraic notation, understand piece abbreviations, and recognize special moves like castling (O-O), captures (x), and check (+).'
      },
      {
        title: 'Basic Rules & Objectives',
        level: 'Beginner',
        concept: 'Master the core rules and understand how to win at chess.',
        pgn: 'e4 e5 2. Qh5 Nc6 3. Bc4 Nf6 4. Qxf7#',
        writeup: 'Learn the essential rules of chess including check, checkmate, stalemate, and various draw conditions. Understand the objective of the game and what constitutes legal vs illegal moves.'
      }
    ],
    variations: [],
    practice: [],
    quiz: [
      {
        ...
        options: ["Forward one square", "Diagonally", "Like a knight", "Any direction"],
        answer: "Forward one square"
      },
      {
        question: "What does 'O-O' mean in chess notation?",
        options: ["Kingside castling", "Queenside castling", "Pawn move", "Knight move"],
        answer: "Kingside castling"
      },
      {
        question: "What is the goal of chess?",
        options: ["Checkmate the opponent's king", "Capture all pieces", "Control the center", "Move all pawns"],
        answer: "Checkmate the opponent's king"
      },
      {
        question: "How does a knight move?",
        options: ["L-shape: 2 squares in one direction, then 1 square perpendicular", "Straight lines", "Diagonally", "Like a pawn"],
        answer: "L-shape: 2 squares in one direction, then 1 square perpendicular"
      },
      {
        question: "What is a stalemate?",
        options: ["Draw when king has no legal moves but is not in check", "Checkmate", "Illegal move", "Pawn promotion"],
        answer: "Draw when king has no legal moves but is not in check"
      }
    ],
    reviewGames: []
  },
  ...
  },
  {
    ...
    title: 'D4 Openings',
    subtitle: '',
    description: 'Master essential D4 openings for White, covering the Queen\'s Gambit, London System, and Colle System. Learn strategic concepts, typical middlegame plans, and how to maintain the initiative throughout the game.',
    difficulty: 'Intermediate',
    estimatedTime: '2.5 hours',
    youWillLearn: [
      "Master the classic Queen's Gambit.",
      "Learn the solid London System.",
    ...
    lessons: [
      {
        title: 'Queen\'s Gambit – Building Center Dominance',
        level: 'Intermediate',
        concept: 'Master the Queen\'s Gambit and its strategic concepts.',
        pgn: 'd4 d5 2. c4 e6 3. Nc3 Nf6 4. Bg5 Be7 5. e3 O-O 6. Nf3 Nbd7',
        writeup: 'The Queen\'s Gambit is one of the most important openings in chess. It\'s a strategic opening that focuses on controlling the center and creating long-term pressure.'
      },
      {
        title: 'London System – Solid and Reliable',
        level: 'Intermediate',
        concept: 'Learn the London System and its positional concepts.',
        pgn: 'd4 Nf6 2. Bf4 d5 3. e3 c5 4. c3 Nc6 5. Nf3 Bg4 6. Nbd2 e6',
        writeup: 'The London System is a solid and flexible opening that works against any Black defense. It\'s characterized by early bishop development to f4 and a solid pawn structure.'
      },
      {
        title: 'Colle System – Attacking with Precision',
        level: 'Intermediate',
        concept: 'Master the Colle System and its attacking concepts.',
        pgn: 'd4 d5 2. Nf3 Nf6 3. e3 e6 4. Bd3 c5 5. c3 Nc6 6. Nbd2 Bd6',
        writeup: 'The Colle System is an attacking opening that leads to kingside attacks and tactical opportunities. It\'s characterized by a solid pawn structure and the bishop development to d3.'
      }
    ],
    variations: [],
    practice: [],
    quiz: [
      ...
      {
        question: "What characterizes the London System?",
        options: ["Early bishop to f4", "Fast pawn storm", "Control f-file", "Trade queens early"],
        answer: "Early bishop to f4"
      },
      {
        question: "What's the Colle System known for?",
        options: ["Kingside attacks", "Fast pawn storm", "Control f-file", "Trade queens early"],
        answer: "Kingside attacks"
      }
    ],
    reviewGames: []
  },
