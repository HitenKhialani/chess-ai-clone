            ...
            <div className="grid grid-cols-3 gap-2 text-sm text-purple-100">
              ...
              {movePairs.map((pair, idx) => (
                <React.Fragment key={idx}>
                  ...
                  <div className={moveIndex - 1 === idx * 2 ? "bg-purple-700 text-[var(--accent-foreground)] rounded px-1" : ""}>{pair[0]}</div>
                  <div className={moveIndex - 1 === idx * 2 + 1 ? "bg-purple-700 text-[var(--accent-foreground)] rounded px-1" : ""}>{pair[1]}</div>
                </React.Fragment>
              ))}
            </div>
          </div>
