...
const moveExplanations = [
  "1.Qh7#: Classic back-rank checkmate - The queen delivers checkmate by attacking the king on the back rank."
];

const theoryTips = [
  "🎯 Look for back-rank weaknesses",
  "⚡ Queen and rook combinations are deadly",
  "🛡️ Control key squares around the king",
  "🎪 Create mating nets with multiple pieces",
  "📐 Coordinate your attacking pieces"
];
      ...
      <div className="bg-gradient-to-r from-red-600 to-orange-600 text-[var(--card-foreground)] p-6">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-3xl font-bold mb-2">
            Lesson 1: Classic Checkmates – Direct Attacks
          </h1>
          <p className="text-red-100">
            Learn classic attacking patterns and tactical combinations
          </p>
        </div>
      </div>
          ...
          <div className="w-2/5 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-950/30 dark:to-indigo-950/30 rounded-2xl p-6 border border-[var(--border)] dark:border-blue-800 shadow-xl hover:shadow-2xl transition-all duration-300 flex flex-col">
            ...
            <div className="flex items-center mb-4">
              ...
              <div>
                ...
                <div className="flex gap-2 mt-1">
                  ...
                  <span className="bg-[var(--primary)] text-[var(--card-foreground)] px-2 py-1 rounded text-xs font-bold shadow-md">Tactics</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-[var(--card)] dark:bg-[var(--card)] rounded-xl p-4 mb-4 shadow-lg">
              ...
              <p className="text-[var(--card-foreground)] dark:text-[var(--muted-foreground)] text-sm leading-relaxed mb-3">
                Players learn classic attacking patterns like the back-rank mate, smothered mate, and basic two-piece checkmates. These attacking themes are essential building blocks for sharp tactical play and quick victories.
              </p>
