...
const lessons = [
  {
    ...
    difficulty: 'Easy',
    href: '/learn/courses/attacking-chess-lesson-1',
  },
  {
    number: 2,
    title: 'Sacrifices to Destroy Defense',
    difficulty: 'Intermediate',
    href: '/learn/courses/attacking-chess-lesson-2',
  },
  {
    number: 3,
    title: 'Attack with Pawns – The Pawn Storm',
    difficulty: 'Advanced',
    href: '/learn/courses/attacking-chess-lesson-3',
  },
];
  ...
  return (
    <main className="min-h-screen bg-[var(--background)] text-[var(--primary-text)] px-4 py-10 flex justify-center">
      <div className="max-w-2xl w-full">
        <h1 className="text-3xl font-bold mb-8">Attacking Chess – Lessons</h1>
