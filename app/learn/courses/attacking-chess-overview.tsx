      ...
      <Card className="bg-[var(--card)] border-[var(--border)] hover:shadow-xl transition-all duration-300">
        <CardHeader>
          ...
          <CardDescription className="text-[var(--muted-foreground)] text-lg">
            Everything you need to know about the Attacking Chess Course
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-8">
          ...
          <div className="bg-[var(--card)] rounded-lg p-6">
            <p className="text-[var(--primary-text)] leading-relaxed text-lg">
              The <b>Attacking Chess</b> course teaches players how to create powerful attacks against the opponent's king and weak squares. 
              Players will develop tactical vision, learn key attack patterns, and build the confidence to sacrifice material for strong initiative.
            </p>
          </div>
          ...
          <div className="bg-[var(--card)] rounded-lg p-6">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="font-semibold text-[var(--accent)]">Launch Attacks</h4>
                  <p className="text-sm text-[var(--muted-foreground)]">Create powerful attacks against the king and weak squares</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="font-semibold text-[var(--accent)]">Checkmating Patterns</h4>
                  <p className="text-sm text-[var(--muted-foreground)]">Master classic tactical motifs and checkmate patterns</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="font-semibold text-[var(--accent)]">Material Sacrifices</h4>
                  <p className="text-sm text-[var(--muted-foreground)]">Learn when and how to sacrifice for initiative</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="font-semibold text-[var(--accent)]">Pawn Storms</h4>
                  <p className="text-sm text-[var(--muted-foreground)]">Use pawn storms to break through defenses</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-[var(--card)] rounded-lg p-6">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              <div className="text-center p-4 bg-[var(--secondary)] rounded-lg">
                ...
                <h4 className="font-semibold text-[var(--accent)] mb-2">Tactical Vision</h4>
              ...
              <div className="text-center p-4 bg-[var(--secondary)] rounded-lg">
                ...
                <h4 className="font-semibold text-[var(--accent)] mb-2">Attack Patterns</h4>
                <p className="text-sm text-[var(--muted-foreground)]">Master classic attacking motifs</p>
              </div>
              <div className="text-center p-4 bg-[var(--secondary)] rounded-lg">
                <div className="w-12 h-12 bg-[var(--accent)] text-[var(--card-foreground)] rounded-full flex items-center justify-center mx-auto mb-3">
                  <Sparkles className="w-6 h-6" />
                </div>
                <h4 className="font-semibold text-[var(--accent)] mb-2">Confidence Building</h4>
                <p className="text-sm text-[var(--muted-foreground)]">Build attacking confidence</p>
          </div>
        </div>
      </div>
