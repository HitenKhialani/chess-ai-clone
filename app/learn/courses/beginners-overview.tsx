...
import { BookOpen, Clock, Target, CheckCircle, Star, Users, Trophy, Sparkles, ArrowLeft } from "lucide-react";
import Link from "next/link";

export default function BeginnersOverview() {
  return (
      ...
      <Card className="bg-[var(--card)] border-[var(--border)] hover:shadow-xl transition-all duration-300">
        <CardHeader>
          ...
          <CardDescription className="text-[var(--muted-foreground)] text-lg">
            Everything you need to know about the Beginners Course
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-8">
          ...
          <div className="bg-[var(--card)] rounded-lg p-6">
            <p className="text-[var(--primary-text)] leading-relaxed text-lg">
              This comprehensive beginner course covers all the essential elements needed to start playing chess. 
              From understanding how pieces move to mastering chess notation, you'll build a solid foundation 
              that will serve you throughout your chess journey.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="flex justify-between items-center p-4 bg-[var(--secondary)] rounded-lg">
              ...
              <div className="bg-[var(--accent)] text-[var(--card-foreground)] px-3 py-1 rounded text-sm font-bold">Beginner</div>
            </div>
            <div className="flex justify-between items-center p-4 bg-[var(--secondary)] rounded-lg">
              <span className="text-[var(--primary-text)] font-semibold">Duration:</span>
              <div className="bg-[var(--accent)] text-[var(--card-foreground)] px-3 py-1 rounded text-sm font-bold">1.5 hours</div>
            </div>
            <div className="flex justify-between items-center p-4 bg-[var(--secondary)] rounded-lg">
          ...
          <div className="bg-[var(--card)] rounded-lg p-6">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="font-semibold text-[var(--accent)]">Piece Movements</h4>
                  <p className="text-sm text-[var(--muted-foreground)]">Master how each chess piece moves and captures</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="font-semibold text-[var(--accent)]">Chess Notation</h4>
                  <p className="text-sm text-[var(--muted-foreground)]">Learn to read and write chess moves</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="font-semibold text-[var(--accent)]">Game Rules</h4>
                  <p className="text-sm text-[var(--muted-foreground)]">Understand check, checkmate, and special moves</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="font-semibold text-[var(--accent)]">Winning Strategies</h4>
                  <p className="text-sm text-[var(--muted-foreground)]">Learn how to win and achieve your goals</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-[var(--card)] rounded-lg p-6">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              <div className="text-center p-4 bg-[var(--secondary)] rounded-lg">
                ...
                <h4 className="font-semibold text-[var(--accent)] mb-2">Interactive Learning</h4>
                <p className="text-sm text-[var(--muted-foreground)]">Animated chess pieces make learning fun</p>
              </div>
              <div className="text-center p-4 bg-[var(--secondary)] rounded-lg">
                <div className="w-12 h-12 bg-[var(--accent)] text-[var(--card-foreground)] rounded-full flex items-center justify-center mx-auto mb-3">
                  <Sparkles className="w-6 h-6" />
                </div>
                <h4 className="font-semibold text-[var(--accent)] mb-2">Step-by-Step</h4>
                <p className="text-sm text-[var(--muted-foreground)]">Progressive learning approach</p>
              </div>
              <div className="text-center p-4 bg-[var(--secondary)] rounded-lg">
                <div className="w-12 h-12 bg-[var(--accent)] text-[var(--card-foreground)] rounded-full flex items-center justify-center mx-auto mb-3">
                  <Sparkles className="w-6 h-6" />
                </div>
                <h4 className="font-semibold text-[var(--accent)] mb-2">Comprehensive</h4>
                <p className="text-sm text-[var(--muted-foreground)]">Covers all chess fundamentals</p>
              </div>
            </div>
          </div>
