    ...
    <main className="min-h-screen bg-[var(--background)] text-[var(--primary-text)]">
      ...
      <div className="bg-gradient-to-r from-orange-600 to-amber-600 text-[var(--card-foreground)] p-6">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-3xl font-bold mb-2">Lesson 1: Bishop vs Knight Fundamentals</h1>
          <p className="text-orange-100">Learn the fundamental principles of bishop vs knight endgames and their key characteristics.</p>
        </div>
      </div>
        ...
        <div className="min-h-[60vh] lg:min-h-[70vh] flex flex-col lg:flex-row gap-4 lg:gap-6 p-4 lg:p-6">
          ...
          <div className="w-full lg:w-2/5 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-950/30 dark:to-indigo-950/30 rounded-2xl p-6 border border-[var(--border)] dark:border-blue-800 shadow-xl hover:shadow-2xl transition-all duration-300 flex flex-col">
            ...
            <div className="flex items-center mb-4">
              <div className="w-12 h-12 bg-[var(--primary)] text-[var(--card-foreground)] rounded-full flex items-center justify-center text-lg font-bold mr-3 shadow-lg">1</div>
              <div>
                <h2 className="text-xl font-bold text-[var(--primary)] dark:text-orange-300">Bishop vs Knight Fundamentals</h2>
            ...
            <div className="bg-[var(--card)] dark:bg-[var(--card)] rounded-xl p-4 mb-4 shadow-lg">
              ...
              <p className="text-[var(--card-foreground)] dark:text-[var(--muted-foreground)] text-sm leading-relaxed mb-3">
                Bishops control long diagonals and excel in open positions; knights thrive in closed structures. In bishop vs knight endgames, prioritize space, create passed pawns, and use the bishop’s range to restrict the enemy king and knight.
              </p>
            </div>
