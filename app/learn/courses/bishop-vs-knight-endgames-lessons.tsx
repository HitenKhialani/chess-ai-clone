...
const lessons = [
  {
    ...
    difficulty: 'Easy',
    href: '/learn/courses/bishop-vs-knight-endgames-lesson-1',
  },
  {
    number: 2,
    title: 'Restricting the Knight',
    difficulty: 'Intermediate',
    href: '/learn/courses/bishop-vs-knight-endgames-lesson-2',
  },
  {
    number: 3,
    title: 'Winning with the Outside Passed Pawn',
    difficulty: 'Advanced',
    href: '/learn/courses/bishop-vs-knight-endgames-lesson-3',
  },
];
  ...
  return (
    <main className="min-h-screen bg-[var(--background)] text-[var(--primary-text)] px-4 py-10 flex justify-center">
      <div className="max-w-2xl w-full">
        <h1 className="text-3xl font-bold mb-8">Bishop vs Knight Endgames – Lessons</h1>
