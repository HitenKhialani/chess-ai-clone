...
import { BookOpen, Clock, Target, CheckCircle, Star, Users, Trophy, Sparkles, Gamepad2, ArrowLeft } from "lucide-react";
  ...
  return (
    <div className="space-y-8">
      ...
      <Card className="bg-[var(--card)] border-[var(--border)] hover:shadow-xl transition-all duration-300">
        <CardHeader>
          <CardTitle className="flex items-center text-[var(--accent)] text-3xl mb-4">
            <Sparkles className="w-8 h-8 mr-3" />
            Complete Course Overview
          </CardTitle>
          <CardDescription className="text-[var(--muted-foreground)] text-lg">
            Everything you need to know about the Bishop vs Knight Endgames Course
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-8">
          {/* Course Description */}
          <div className="bg-[var(--card)] rounded-lg p-6">
            <p className="text-[var(--accent)] leading-relaxed text-lg">
              Master the intricate endgame battles between bishops and knights. Learn when each piece is stronger, 
              how to create winning positions, and the strategic principles that determine which minor piece 
              dominates in different scenarios.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="flex justify-between items-center p-4 bg-[var(--secondary)] rounded-lg">
              <span className="text-[var(--accent)] font-semibold">Difficulty:</span>
              <div className="bg-[var(--accent)] text-[var(--card-foreground)] px-3 py-1 rounded text-sm font-bold">Advanced</div>
            </div>
            <div className="flex justify-between items-center p-4 bg-[var(--secondary)] rounded-lg">
              <span className="text-[var(--accent)] font-semibold">Duration:</span>
              <div className="bg-[var(--accent)] text-[var(--card-foreground)] px-3 py-1 rounded text-sm font-bold">2.5 hours</div>
            </div>
            <div className="flex justify-between items-center p-4 bg-[var(--secondary)] rounded-lg">
              <span className="text-[var(--accent)] font-semibold">Lessons:</span>
          ...
          <div className="bg-[var(--card)] rounded-lg p-6">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="font-semibold text-[var(--accent)]">Piece Characteristics</h4>
                  <p className="text-sm text-[var(--muted-foreground)]">Understand when bishops or knights are stronger</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="font-semibold text-[var(--accent)]">Strategic Principles</h4>
                  <p className="text-sm text-[var(--muted-foreground)]">Learn the key factors that determine piece superiority</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="font-semibold text-[var(--accent)]">Winning Techniques</h4>
                  <p className="text-sm text-[var(--muted-foreground)]">Master techniques to convert advantages</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="font-semibold text-[var(--accent)]">Practical Applications</h4>
                  <p className="text-sm text-[var(--muted-foreground)]">Apply knowledge in real game situations</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-[var(--card)] rounded-lg p-6">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              <div className="text-center p-4 bg-[var(--secondary)] rounded-lg">
                ...
                <h4 className="font-semibold text-[var(--accent)] mb-2">Endgame Mastery</h4>
                <p className="text-sm text-[var(--muted-foreground)]">Master complex endgame scenarios</p>
              </div>
              <div className="text-center p-4 bg-[var(--secondary)] rounded-lg">
                <div className="w-12 h-12 bg-[var(--accent)] text-[var(--card-foreground)] rounded-full flex items-center justify-center mx-auto mb-3">
                  <Sparkles className="w-6 h-6" />
                </div>
                <h4 className="font-semibold text-[var(--accent)] mb-2">Strategic Thinking</h4>
              ...
              <div className="text-center p-4 bg-[var(--secondary)] rounded-lg">
                ...
                <h4 className="font-semibold text-[var(--accent)] mb-2">Practical Skills</h4>
                <p className="text-sm text-[var(--muted-foreground)]">Apply knowledge in real games</p>
              </div>
            </div>
          </div>
