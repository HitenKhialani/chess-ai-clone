...
const PGN = `1. e4 e5 2. Nf3 Nc6 3. Bc4 Bc5 4. c3 Nf6 5. d4 exd4 6. cxd4 Bb4+ 7. Bd2 Bxd2+ 8. Nbxd2 d5`;
const moves = [
  'e4', 'e5', 'Nf3', 'Nc6', 'Bc4', 'Bc5', 'c3', 'Nf6', 'd4', 'exd4', 'cxd4', 'Bb4+', 'Bd2', 'Bxd2+', 'Nbxd2', 'd5'
];

const moveExplanations = [
  "1.e4 e5: Both sides contest the center with pawn moves.",
  "2.Nf3 Nc6: White develops the knight, Black defends e5.",
  "3.Bc4 Bc5: Both bishops develop to active squares.",
  "4.c3 Nf6: White prepares d4, Black develops the knight.",
  "5.d4 exd4: White challenges the center, Black captures.",
  "6.cxd4 Bb4+: Black pins the knight, creating complications.",
  "7.Bd2 Bxd2+: White unpins, Black exchanges bishops.",
  "8.Nbxd2 d5: Black challenges the center with d5."
];

const theoryTips = [
  "🎯 Control key central squares with pawns and pieces",
...
export default function DefensiveMasteryLesson() {
  ...
  return (
    <main className="min-h-screen bg-[var(--background)] text-[var(--primary-text)]">
      {/* Back Navigation Bar */}
      <div className="bg-gradient-to-r from-indigo-600 to-purple-600 text-[var(--card-foreground)] p-4 shadow-lg">
        <div className="max-w-7xl mx-auto flex items-center">
          <Link 
            href="/learn/courses/defensive-mastery" 
      ...
      {/* Header */}
      <div className="bg-gradient-to-r from-indigo-600 to-purple-600 text-[var(--card-foreground)] p-6">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-3xl font-bold mb-2">
            Lesson 1: Defensive Mastery – Solid Structures
          </h1>
          <p className="text-indigo-100">
            Master defensive techniques and solid positional play
          </p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="h-[60vh] flex gap-6 p-6">
          ...
          <div className="w-3/5 bg-gradient-to-br from-indigo-50 to-purple-50 dark:from-indigo-950/30 dark:to-purple-950/30 rounded-2xl p-6 border border-[var(--border)] dark:border-indigo-800 shadow-xl hover:shadow-2xl transition-all duration-300 flex flex-col justify-center items-center">
            <h3 className="text-xl font-bold mb-4 text-[var(--accent)] dark:text-indigo-300 text-center">
            ...
            <div className="text-center mt-3">
              <div className="bg-[var(--card)] dark:bg-[var(--card)] rounded-lg px-4 py-2 shadow-md">
                <span className="text-sm font-semibold text-[var(--accent)] dark:text-indigo-300">
          ...
          <div className="w-2/5 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-950/30 dark:to-indigo-950/30 rounded-2xl p-6 border border-[var(--border)] dark:border-blue-800 shadow-xl hover:shadow-2xl transition-all duration-300 flex flex-col">
            ...
            <div className="flex items-center mb-4">
              ...
              <div>
                <h2 className="text-xl font-bold text-[var(--accent)] dark:text-indigo-300">
                  Defensive Mastery
                </h2>
                <div className="flex gap-2 mt-1">
                  ...
                  <span className="bg-[var(--primary)] text-[var(--card-foreground)] px-2 py-1 rounded text-xs font-bold shadow-md">Defense</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-[var(--card)] dark:bg-[var(--card)] rounded-xl p-4 mb-4 shadow-lg">
              ...
              <p className="text-[var(--card-foreground)] dark:text-[var(--muted-foreground)] text-sm leading-relaxed mb-3">
                Defensive mastery involves creating solid pawn structures, developing pieces harmoniously, and maintaining king safety. This lesson teaches how to build resilient positions that can withstand attacks.
              </p>
              
              {/* Theory Tips */}
              <div className="bg-gradient-to-r from-indigo-50 to-purple-50 dark:from-indigo-900/20 dark:to-purple-900/20 rounded-lg p-3">
                <h4 className="font-semibold text-indigo-800 dark:text-indigo-200 mb-2 text-sm">💡 Key Principles:</h4>
                <ul className="text-xs text-[var(--accent)] dark:text-indigo-300 space-y-1">
