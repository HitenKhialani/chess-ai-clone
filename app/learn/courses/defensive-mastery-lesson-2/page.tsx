...
const PGN = `1. e4 e5 2. Nf3 Nc6 3. Bc4 Bc5 4. c3 Nf6 5. d3 d6 6. Nbd2 O-O 7. O-O a6 8. Re1 Be6`;
const moves = [
  'e4', 'e5', 'Nf3', 'Nc6', 'Bc4', 'Bc5', 'c3', 'Nf6', 'd3', 'd6', 'Nbd2', 'O-O', 'O-O', 'a6', 'Re1', 'Be6'
];
...
const moveExplanations = [
  ...
  "4.c3 Nf6: White prepares d3, Black develops the kingside knight.",
  "5.d3 d6: White supports the center, Black prepares kingside development.",
  "6.Nbd2 O-O: White develops the queenside knight, Black castles for safety.",
  "7.O-O a6: White castles for king safety, Black prepares queenside expansion.",
  "8.Re1 Be6: White activates the rook, Black develops the bishop."
];
...
export default function DefensiveMasteryLesson2() {
      ...
      <div className="bg-gradient-to-r from-indigo-600 to-purple-600 text-[var(--card-foreground)] p-6">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-3xl font-bold mb-2">
            Lesson 2: Advanced Defensive Techniques
          </h1>
          <p className="text-indigo-100">
            Master advanced defensive strategies
          </p>
        </div>
      </div>
          ...
          <div className="w-2/5 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-950/30 dark:to-indigo-950/30 rounded-2xl p-6 border border-[var(--border)] dark:border-blue-800 shadow-xl hover:shadow-2xl transition-all duration-300 flex flex-col">
            ...
            <div className="bg-[var(--card)] dark:bg-[var(--card)] rounded-xl p-4 mb-4 shadow-lg">
              ...
              <p className="text-[var(--card-foreground)] dark:text-[var(--muted-foreground)] text-sm leading-relaxed mb-3">
                This lesson covers advanced defensive techniques including complex defensive structures, piece coordination, and how to handle various attacking setups with solid defensive play.
              </p>
