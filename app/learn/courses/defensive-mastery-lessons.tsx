...
const lessons = [
  {
    number: 1,
    title: 'Finding Only Moves – Survive Under Pressure',
    difficulty: 'Easy',
    href: '/learn/courses/defensive-mastery-lesson-1',
  },
  {
    number: 2,
    title: 'The Art of Exchange – Removing Attackers',
    difficulty: 'Intermediate',
    href: '/learn/courses/defensive-mastery-lesson-2',
  },
  {
    number: 3,
    title: 'Defensive Counterattack – Turn Defense into Offense',
    difficulty: 'Advanced',
    href: '/learn/courses/defensive-mastery-lesson-3',
  },
];
  ...
  return (
    <main className="min-h-screen bg-[var(--background)] text-[var(--primary-text)] px-4 py-10 flex justify-center">
      <div className="max-w-2xl w-full">
        <h1 className="text-3xl font-bold mb-8">Defensive Mastery – Lessons</h1>
