...
import { BookOpen, Clock, Target, CheckCircle, Star, Users, Trophy, Sparkles, Shield, ArrowLeft } from "lucide-react";
      ...
      <Card className="bg-[var(--card)] border-[var(--border)] hover:shadow-xl transition-all duration-300">
        <CardHeader>
          ...
          <CardDescription className="text-[var(--muted-foreground)] text-lg">
            Everything you need to know about the Defensive Mastery Course
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-8">
          ...
          <div className="bg-[var(--card)] rounded-lg p-6">
            <p className="text-[var(--primary-text)] leading-relaxed text-lg">
              Master the art of defensive chess and learn how to withstand even the most ferocious attacks. 
              This course teaches you defensive techniques, prophylactic thinking, and how to turn defense 
          ...
          <div className="bg-[var(--card)] rounded-lg p-6">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="font-semibold text-[var(--accent)]">Defensive Techniques</h4>
                  <p className="text-sm text-[var(--muted-foreground)]">Master essential defensive moves and strategies</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="font-semibold text-[var(--accent)]">Prophylactic Thinking</h4>
                  <p className="text-sm text-[var(--muted-foreground)]">Learn to anticipate and prevent opponent's threats</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="font-semibold text-[var(--accent)]">Counterattack Skills</h4>
                  <p className="text-sm text-[var(--muted-foreground)]">Turn defense into winning opportunities</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="font-semibold text-[var(--accent)]">Positional Defense</h4>
                  <p className="text-sm text-[var(--muted-foreground)]">Understand defensive structures and setups</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-[var(--card)] rounded-lg p-6">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              <div className="text-center p-4 bg-[var(--secondary)] rounded-lg">
                ...
                <h4 className="font-semibold text-[var(--accent)] mb-2">Defensive Mastery</h4>
                <p className="text-sm text-[var(--muted-foreground)]">Learn to defend against any attack</p>
              </div>
              <div className="text-center p-4 bg-[var(--secondary)] rounded-lg">
                <div className="w-12 h-12 bg-[var(--accent)] text-[var(--card-foreground)] rounded-full flex items-center justify-center mx-auto mb-3">
                ...
                <p className="text-sm text-[var(--muted-foreground)]">Develop prophylactic thinking</p>
              </div>
              <div className="text-center p-4 bg-[var(--secondary)] rounded-lg">
                <div className="w-12 h-12 bg-[var(--accent)] text-[var(--card-foreground)] rounded-full flex items-center justify-center mx-auto mb-3">
                  <Sparkles className="w-6 h-6" />
                </div>
                <h4 className="font-semibold text-[var(--accent)] mb-2">Counterattack Skills</h4>
                <p className="text-sm text-[var(--muted-foreground)]">Turn defense into victory</p>
          </div>
        </div>
      </div>
          ...
          <div className="bg-gradient-to-r from-[var(--accent)] to-[var(--accent-soft)] p-8 rounded-2xl text-center">
            <h2 className="text-3xl font-bold text-[var(--card-foreground)] mb-4">Ready to Master Defensive Chess?</h2>
            <p className="text-[var(--card-foreground)]/90 mb-6 text-lg">
              Learn to defend against any attack and turn defense into victory
            </p>
