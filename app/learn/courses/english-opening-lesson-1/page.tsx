...
const PGN = `1. c4 e5 2. Nc3 Nf6 3. Nf3 Nc6 4. g3 Bb4 5. Bg2 O-O 6. O-O Re8`;
const moves = [
  'c4', 'e5', 'Nc3', 'Nf6', 'Nf3', 'Nc6', 'g3', 'Bb4', 'Bg2', 'O-O', 'O-O', 'Re8'
];

const moveExplanations = [
  "1.c4 e5: English Opening - White controls d5 and e5, Black responds with central counterplay.",
  "2.Nc3 Nf6: Both sides develop knights to control the center and prepare for further development.",
  "3.Nf3 Nc6: White develops the kingside knight, Black continues with natural development.",
  "4.g3 Bb4: White prepares kingside fianchetto, Black pins the knight and prepares to castle.",
  "5.Bg2 O-O: White completes kingside fianchetto, Black castles for king safety.",
  "6.O-O Re8: White castles kingside, Black prepares for central expansion with rook lift."
];
...
export default function EnglishOpeningLesson() {
  ...
  return (
    <main className="min-h-screen bg-[var(--background)] text-[var(--primary-text)]">
      ...
      <div className="bg-gradient-to-r from-amber-600 to-yellow-600 text-[var(--card-foreground)] p-6">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-3xl font-bold mb-2">
            Lesson 1: English Opening – Flank Attack
          </h1>
          <p className="text-amber-100">
            Master the English Opening with strategic flank play and central control
          </p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 lg:px-6">
          ...
          <div className="w-full lg:w-2/5 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-950/30 dark:to-indigo-950/30 rounded-2xl p-6 border border-[var(--border)] dark:border-blue-800 shadow-xl hover:shadow-2xl transition-all duration-300 flex flex-col">
            ...
            <div className="flex items-center mb-4">
              ...
              <div>
                ...
                <div className="flex gap-2 mt-1">
                  ...
                  <span className="bg-[var(--primary)] text-[var(--card-foreground)] px-2 py-1 rounded text-xs font-bold shadow-md">Flank</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-[var(--card)] dark:bg-[var(--card)] rounded-xl p-4 mb-4 shadow-lg">
              ...
              <p className="text-[var(--card-foreground)] dark:text-[var(--muted-foreground)] text-sm leading-relaxed mb-3">
                The English Opening is a flexible flank opening that controls key central squares from the side. It allows White to avoid many sharp theoretical lines while maintaining good chances for advantage through strategic play.
              </p>
        ...
        {/* BOTTOM - Enhanced Step-by-Step Cards (Responsive, no fixed height) */}
