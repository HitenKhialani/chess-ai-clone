...
export default function EnglishFourKnightsLesson() {
  ...
  return (
    <main className="min-h-screen bg-[var(--background)] text-[var(--primary-text)] px-4 py-10 flex justify-center">
      <div className="max-w-7xl w-full grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch">
        {/* Left: Explanation */}
        <div className="bg-[var(--card)] rounded-xl shadow-lg p-8 flex flex-col h-[600px]">
          <div>
            <h1 className="text-3xl font-bold mb-4">Lesson 1: English Four Knights – Classical Development</h1>
            ...
            <p className="mb-4">The English Four Knights is a simple and harmonious opening where both sides develop naturally. It emphasizes central control and quick king safety.</p>
            <div className="mb-4">
