...
const PGN = `1.c4 e5 2.Nc3 Nf6 3.Nf3 Nc6 4.g3`;
...
const moveExplanations = [
  "1.c4 e5: Black occupies the center; White chooses flank start.",
  "2.Nc3 Nf6 3.Nf3 Nc6: Both sides develop knights toward the center.",
  "4.g3: Prepares fianchetto and kingside safety."
];

export default function EnglishFourKnightsLesson() {
      ...
      <div className="w-full max-w-[1200px] flex flex-row justify-center items-start gap-x-8">
        ...
        <div className="bg-[var(--card)] text-[var(--primary-text)] rounded-xl shadow-xl p-6 w-[400px] min-w-[400px] max-w-[400px] h-[540px] flex flex-col border border-[var(--border)]">
          <div className="flex gap-2 mb-2">
            ...
            <span className="bg-blue-600 text-xs font-bold text-white px-2 py-1 rounded">Classical</span>
          </div>
          <h1 className="text-3xl font-bold mb-2 text-[var(--primary-text)]">Lesson 1: English Four Knights – Classical Development</h1>
          <div className="flex-1 overflow-y-auto mb-4">
            <p className="text-base text-[var(--secondary-text)]">
              The English Four Knights is a simple and harmonious opening where both sides develop naturally. It emphasizes central control and quick king safety.
            </p>
            <h2 className="font-bold text-base mb-1 mt-2 text-[var(--primary-text)]">Fundamentals (Chess Trainer Explanation)</h2>
            <p className="mb-2 text-[var(--secondary-text)]">The English Four Knights is a simple and harmonious opening where both sides develop naturally. It emphasizes central control and quick king safety.</p>
          </div>
