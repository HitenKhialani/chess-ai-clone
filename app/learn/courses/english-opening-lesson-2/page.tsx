      ...
      <div className="w-full max-w-[1200px] flex flex-row justify-center items-start gap-x-8">
        ...
        <div className="bg-[var(--card)] text-[var(--primary-text)] rounded-xl shadow-xl p-6 w-[400px] min-w-[400px] max-w-[400px] h-[540px] flex flex-col border border-[var(--border)]">
          <div className="flex gap-2 mb-2">
            ...
            <span className="bg-blue-600 text-xs font-bold text-white px-2 py-1 rounded">Strategic</span>
          </div>
          <h1 className="text-3xl font-bold mb-2 text-[var(--primary-text)]">Lesson 2: Botvinnik System – Deep Strategic Play</h1>
          <div className="flex-1 overflow-y-auto mb-4">
            ...
            <p className="mb-2 text-[var(--secondary-text)]">The Botvinnik System is a deep strategic setup focusing on long-term positional pressure, especially with the fianchettoed bishop and central pawn levers.</p>
          </div>
