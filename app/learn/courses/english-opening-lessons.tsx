...
const lessons = [
  {
    ...
    difficulty: 'Easy',
    href: '/learn/courses/english-opening-lesson-1',
  },
  {
    number: 2,
    title: 'Botvinnik System – Deep Strategic Play',
    difficulty: 'Intermediate',
    href: '/learn/courses/english-opening-lesson-2',
  },
  {
    number: 3,
    title: 'Reversed Sicilian – Flank Attack',
    difficulty: 'Advanced',
    href: '/learn/courses/english-opening-lesson-3',
  },
];
  ...
  return (
    <main className="min-h-screen bg-[var(--background)] text-[var(--primary-text)] px-4 py-10 flex justify-center">
      <div className="max-w-2xl w-full">
        <h1 className="text-3xl font-bold mb-8">1.c4 Openings Explained – Lessons</h1>
