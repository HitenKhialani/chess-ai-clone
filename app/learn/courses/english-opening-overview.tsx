      ...
      <Card className="bg-[var(--card)] border-[var(--border)] hover:shadow-xl transition-all duration-300">
        <CardHeader>
          ...
          <CardDescription className="text-[var(--muted-foreground)] text-lg">
            Everything you need to know about the English Opening Course
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-8">
          ...
          <div className="bg-[var(--card)] rounded-lg p-6">
            <p className="text-[var(--primary-text)] leading-relaxed text-lg">
              Master the English Opening, a flexible and strategic opening that can lead to both tactical and positional games. 
              Learn the key ideas, typical middlegame plans, and how to handle various black responses to 1.c4.
            </p>
          </div>
          ...
          <div className="bg-[var(--card)] rounded-lg p-6">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="font-semibold text-[var(--accent)]">Opening Principles</h4>
                  <p className="text-sm text-[var(--muted-foreground)]">Master the key ideas behind 1.c4</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="font-semibold text-[var(--accent)]">Middlegame Plans</h4>
                  <p className="text-sm text-[var(--muted-foreground)]">Learn typical plans and strategies</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="font-semibold text-[var(--accent)]">Black Responses</h4>
                  <p className="text-sm text-[var(--muted-foreground)]">Handle various defensive setups</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
          ...
          <div className="bg-[var(--card)] rounded-lg p-6">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              <div className="text-center p-4 bg-[var(--secondary)] rounded-lg">
                ...
                <h4 className="font-semibold text-[var(--accent)] mb-2">Opening Mastery</h4>
                <p className="text-sm text-[var(--muted-foreground)]">Master a complete opening system</p>
              </div>
              <div className="text-center p-4 bg-[var(--secondary)] rounded-lg">
                <div className="w-12 h-12 bg-[var(--accent)] text-[var(--card-foreground)] rounded-full flex items-center justify-center mx-auto mb-3">
                  <Sparkles className="w-6 h-6" />
              ...
              <div className="text-center p-4 bg-[var(--secondary)] rounded-lg">
                ...
                <p className="text-sm text-[var(--muted-foreground)]">Adapt to different game types</p>
              </div>
            </div>
          </div>
