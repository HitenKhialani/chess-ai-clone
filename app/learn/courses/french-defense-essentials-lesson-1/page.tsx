      ...
      <div className="w-full max-w-[1200px] flex flex-row justify-center items-start gap-x-8">
        ...
        <div className="bg-[var(--card)] text-[var(--primary-text)] rounded-xl shadow-xl p-6 w-[400px] min-w-[400px] max-w-[400px] h-[540px] flex flex-col border border-[var(--border)]">
          <div className="flex gap-2 mb-2">
            <span className="bg-[var(--accent)] text-xs font-bold text-white px-2 py-1 rounded">Easy</span>
            <span className="bg-blue-600 text-xs font-bold text-white px-2 py-1 rounded">Positional</span>
          </div>
          <h1 className="text-3xl font-bold mb-2 text-[var(--primary-text)]">Lesson 1: Advance Variation – Space Advantage</h1>
          <div className="flex-1 overflow-y-auto max-h-[120px] mb-4">
            <p className="text-base text-[var(--secondary-text)]">
              The Advance Variation is a solid, space-gaining system for White. Black must patiently break down White's pawn chain. Players learn to manage cramped positions, prepare pawn breaks, and create counterplay with precise timing.
            </p>
            <h2 className="font-bold text-base mb-1 mt-2 text-[var(--primary-text)]">Fundamentals (Chess Trainer Explanation)</h2>
            <p className="mb-2 text-[var(--secondary-text)]">The Advance Variation is a solid, space-gaining system for White. Black must patiently break down White's pawn chain. Players learn to manage cramped positions, prepare pawn breaks, and create counterplay with precise timing.</p>
          </div>
