      ...
      <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-[var(--card-foreground)] p-6">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-3xl font-bold mb-2">
            Lesson 2: Tarrasch Variation – Flexible Structure
          </h1>
          <p className="text-blue-100">
            Learn flexible piece development and dynamic pawn play while fighting for the center.
          </p>
        </div>
      </div>
        ...
        <div className="min-h-[60vh] lg:min-h-[70vh] flex flex-col lg:flex-row gap-4 lg:gap-6 p-4 lg:p-6">
          ...
          <div className="w-full lg:w-2/5 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-950/30 dark:to-indigo-950/30 rounded-2xl p-6 border border-[var(--border)] dark:border-blue-800 shadow-xl hover:shadow-2xl transition-all duration-300 flex flex-col">
            <div className="flex items-center mb-4">
              ...
              <div>
                <h2 className="text-xl font-bold text-[var(--primary)] dark:text-blue-300">Tarrasch Variation</h2>
                <div className="flex gap-2 mt-1">
                  ...
                  <span className="bg-[var(--primary)] text-[var(--card-foreground)] px-2 py-1 rounded text-xs font-bold shadow-md">Flexible</span>
                </div>
              </div>
            </div>
            <div className="bg-[var(--card)] dark:bg-[var(--card)] rounded-xl p-4 mb-4 shadow-lg">
              ...
              <p className="text-[var(--card-foreground)] dark:text-[var(--muted-foreground)] text-sm leading-relaxed mb-3">The Tarrasch Variation aims for open lines and dynamic pawn play while avoiding structural weaknesses common in other French lines.</p>
            </div>
