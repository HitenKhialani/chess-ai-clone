    ...
    <main className="min-h-screen bg-[var(--background)] text-[var(--primary-text)] px-4 py-10 flex justify-center">
      <div className="w-full max-w-[1200px] flex flex-row justify-center items-start gap-x-8">
        ...
        <div className="bg-[var(--card)] text-[var(--primary-text)] rounded-xl shadow-xl p-6 w-[400px] min-w-[400px] max-w-[400px] h-[540px] flex flex-col border border-[var(--border)]">
          ...
          <h1 className="text-3xl font-bold mb-2 text-[var(--primary-text)]">Lesson 2: Tarrasch Variation – Flexible Structure</h1>
          <div className="flex-1 overflow-y-auto max-h-[120px] mb-4">
            <p className="text-base text-[var(--secondary-text)]">
              The Tarrasch Variation aims for open lines and dynamic pawn play. Players learn flexible piece development, fighting for the center, and creating attacking chances while avoiding the structural weaknesses common in other French lines.
            </p>
            <h2 className="font-bold text-base mb-1 mt-2 text-[var(--primary-text)]">Fundamentals (Chess Trainer Explanation)</h2>
            <p className="mb-2 text-[var(--secondary-text)]">The Tarrasch Variation aims for open lines and dynamic pawn play. Players learn flexible piece development, fighting for the center, and creating attacking chances while avoiding the structural weaknesses common in other French lines.</p>
          </div>
