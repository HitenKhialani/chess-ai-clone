      ...
      <Card className="bg-[var(--card)] border-[var(--border)] hover:shadow-xl transition-all duration-300">
        <CardHeader>
          ...
          <CardDescription className="text-[var(--muted-foreground)] text-lg">
            Everything you need to know about the French Defense Essentials Course
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-8">
          ...
          <div className="bg-[var(--card)] rounded-lg p-6">
            <p className="text-[var(--primary-text)] leading-relaxed text-lg">
              Master the French Defense, a solid and strategic opening that can lead to complex middlegame positions. 
              Learn the key ideas, typical pawn structures, and how to handle various white attacks against 1...e6.
            </p>
          </div>
          ...
          <div className="bg-[var(--card)] rounded-lg p-6">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="font-semibold text-[var(--accent)]">Defensive Principles</h4>
                  <p className="text-sm text-[var(--muted-foreground)]">Master solid defensive play with 1...e6</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-[var(--muted-foreground)]">Understand typical French Defense structures</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="font-semibold text-[var(--accent)]">Counterplay</h4>
                  <p className="text-sm text-[var(--muted-foreground)]">Learn to create counterplay opportunities</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-[var(--muted-foreground)]">Develop positional understanding</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-[var(--card)] rounded-lg p-6">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              <div className="text-center p-4 bg-[var(--secondary)] rounded-lg">
                ...
                <h4 className="font-semibold text-[var(--accent)] mb-2">Solid Defense</h4>
                <p className="text-sm text-[var(--muted-foreground)]">Learn a reliable defensive system</p>
              </div>
              <div className="text-center p-4 bg-[var(--secondary)] rounded-lg">
                <div className="w-12 h-12 bg-[var(--accent)] text-[var(--card-foreground)] rounded-full flex items-center justify-center mx-auto mb-3">
              ...
              <div className="text-center p-4 bg-[var(--secondary)] rounded-lg">
                ...
                <h4 className="font-semibold text-[var(--accent)] mb-2">Counterplay</h4>
                <p className="text-sm text-[var(--muted-foreground)]">Learn to create winning chances</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-r from-[var(--accent)] to-[var(--accent-soft)] p-8 rounded-2xl text-center">
            ...
            <Link href="/learn/courses/french-defense-essentials-lesson-1">
