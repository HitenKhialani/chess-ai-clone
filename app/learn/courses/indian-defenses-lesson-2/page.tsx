...
const PGN = `1. d4 Nf6 2. c4 e6 3. Nc3 Bb4 4. e3 O-O 5. Bd3 d5 6. Nf3 c5 7. O-O Nc6 8. a3 Bxc3`;
const moves = [
  'd4', 'Nf6', 'c4', 'e6', 'Nc3', 'Bb4', 'e3', 'O-O', 'Bd3', 'd5', 'Nf3', 'c5', 'O-O', 'Nc6', 'a3', 'Bxc3'
];
...
const moveExplanations = [
  ...
  "7.O-O Nc6: White castles for king safety, Black develops the queenside knight.",
  "8.a3 Bxc3: White prepares to break the pin, Black exchanges bishops."
];
...
export default function IndianDefensesLesson2() {
    ...
    <main className="min-h-screen bg-[var(--background)] text-[var(--primary-text)]">
      ...
      <div className="bg-gradient-to-r from-orange-600 to-amber-600 text-[var(--card-foreground)] p-4 shadow-lg">
        <div className="max-w-7xl mx-auto flex items-center">
          <Link 
            href="/learn/courses/indian-defenses" 
      ...
      <div className="bg-gradient-to-r from-orange-600 to-amber-600 text-[var(--card-foreground)] p-6">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-3xl font-bold mb-2">
            Lesson 2: Advanced Indian Defense Concepts
          </h1>
          <p className="text-orange-100">
            Master advanced Indian Defense strategies
          </p>
        </div>
      </div>
          ...
          <div className="w-3/5 bg-gradient-to-br from-orange-50 to-amber-50 dark:from-orange-950/30 dark:to-amber-950/30 rounded-2xl p-6 border border-[var(--border)] dark:border-orange-800 shadow-xl hover:shadow-2xl transition-all duration-300 flex flex-col justify-center items-center">
            ...
            <div className="text-center mt-3">
              <div className="bg-[var(--card)] dark:bg-[var(--card)] rounded-lg px-4 py-2 shadow-md">
                <span className="text-sm font-semibold text-[var(--primary)] dark:text-orange-300">
          ...
          <div className="w-2/5 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-950/30 dark:to-indigo-950/30 rounded-2xl p-6 border border-[var(--border)] dark:border-blue-800 shadow-xl hover:shadow-2xl transition-all duration-300 flex flex-col">
            ...
            <div className="flex items-center mb-4">
              ...
              <div>
                <h2 className="text-xl font-bold text-[var(--primary)] dark:text-orange-300">
                  Advanced Indian Defense Concepts
                </h2>
                <div className="flex gap-2 mt-1">
                  <span className="bg-[var(--primary)] text-[var(--card-foreground)] px-2 py-1 rounded text-xs font-bold shadow-md">Intermediate</span>
            ...
            <div className="bg-[var(--card)] dark:bg-[var(--card)] rounded-xl p-4 mb-4 shadow-lg">
              ...
              <p className="text-[var(--card-foreground)] dark:text-[var(--muted-foreground)] text-sm leading-relaxed mb-3">
                This lesson covers advanced Indian Defense concepts including complex pawn structures, piece coordination, and how to handle various white setups with flexible and dynamic play.
              </p>
              
              {/* Theory Tips */}
              <div className="bg-gradient-to-r from-orange-50 to-amber-50 dark:from-orange-900/20 dark:to-amber-900/20 rounded-lg p-3">
                <h4 className="font-semibold text-orange-800 dark:text-orange-200 mb-2 text-sm">💡 Key Principles:</h4>
                <ul className="text-xs text-[var(--primary)] dark:text-orange-300 space-y-1">
