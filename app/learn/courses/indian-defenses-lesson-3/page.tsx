    ...
    <main className="min-h-screen bg-[var(--background)] text-[var(--primary-text)] px-4 py-10 flex justify-center">
      <div className="w-full max-w-[1200px] flex flex-row justify-center items-start gap-x-8">
        ...
        <div className="bg-[var(--card)] text-[var(--primary-text)] rounded-xl shadow-xl p-6 w-[400px] min-w-[400px] max-w-[400px] h-[540px] flex flex-col border border-[var(--border)]">
          ...
          <h1 className="text-3xl font-bold mb-2 text-[var(--primary-text)]">Lesson 3: Benoni Defense – Aggressive Pawn Play</h1>
          <div className="flex-1 overflow-y-auto mb-4">
            ...
            <p className="mb-2 text-[var(--secondary-text)]">The Benoni Defense creates sharp, imbalanced pawn structures where Black aggressively challenges White's center. Players learn to handle space disadvantages, use open files, and launch counterattacks with timely pawn breaks. The Benoni is perfect for players who enjoy tactical, high-pressure positions requiring precise calculation.</p>
          </div>
