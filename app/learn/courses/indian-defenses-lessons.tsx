...
const lessons = [
  {
    number: 1,
    title: 'Old Indian Defense – Classical Solid Defense',
    difficulty: 'Easy',
    href: '/learn/courses/indian-defenses-lesson-1',
  },
  {
    number: 2,
    title: 'Grünfeld Defense – Hypermodern Counterattack',
    difficulty: 'Intermediate',
    href: '/learn/courses/indian-defenses-lesson-2',
  },
  {
    number: 3,
    title: 'Benoni Defense – Aggressive Pawn Play',
    difficulty: 'Advanced',
    href: '/learn/courses/indian-defenses-lesson-3',
  },
];
  ...
  return (
    <main className="min-h-screen bg-[var(--background)] text-[var(--primary-text)] px-4 py-10 flex justify-center">
      <div className="max-w-2xl w-full">
        <h1 className="text-3xl font-bold mb-8">Indian Game Structures Explained – Lessons</h1>
