...
export default function OneD4OpeningsOverview() {
  return (
      ...
      <Card className="bg-[var(--card)] border-[var(--border)] hover:shadow-xl transition-all duration-300">
        <CardHeader>
          ...
          <CardDescription className="text-[var(--muted-foreground)] text-lg">
            Everything you need to know about the D4 Openings Course
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-8">
          ...
          <div className="bg-[var(--card)] rounded-lg p-6">
            <p className="text-[var(--primary-text)] leading-relaxed text-lg">
              Master essential D4 openings for White, covering the Queen's Gambit, London System, and Colle System. 
              Learn strategic concepts, typical middlegame plans, and how to maintain the initiative throughout the game.
            </p>
          </div>
          ...
          <div className="bg-[var(--card)] rounded-lg p-6">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="font-semibold text-[var(--accent)]">Queen's Gambit</h4>
                  <p className="text-sm text-[var(--muted-foreground)]">Master the classic Queen's Gambit</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="font-semibold text-[var(--accent)]">London System</h4>
                  <p className="text-sm text-[var(--muted-foreground)]">Learn the solid London System</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="font-semibold text-[var(--accent)]">Colle System</h4>
                  <p className="text-sm text-[var(--muted-foreground)]">Master the attacking Colle System</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
          ...
          <div className="bg-[var(--card)] rounded-lg p-6">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              <div className="text-center p-4 bg-[var(--secondary)] rounded-lg">
                ...
                <h4 className="font-semibold text-[var(--accent)] mb-2">Complete Repertoire</h4>
                <p className="text-sm text-[var(--muted-foreground)]">Master three essential D4 openings</p>
              </div>
              <div className="text-center p-4 bg-[var(--secondary)] rounded-lg">
                <div className="w-12 h-12 bg-[var(--accent)] text-[var(--card-foreground)] rounded-full flex items-center justify-center mx-auto mb-3">
                  <Sparkles className="w-6 h-6" />
              ...
              <div className="text-center p-4 bg-[var(--secondary)] rounded-lg">
                ...
                <h4 className="font-semibold text-[var(--accent)] mb-2">Initiative Play</h4>
                <p className="text-sm text-[var(--muted-foreground)]">Learn to control the game</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-r from-[var(--accent)] to-[var(--accent-soft)] p-8 rounded-2xl text-center">
            ...
            <Link href="/learn/courses/one-d4-openings-lesson-1">
