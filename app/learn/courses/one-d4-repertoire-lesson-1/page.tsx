...
const PGN = `1. d4 Nf6 2. c4 e6 3. Nc3 Bb4 4. e3 O-O 5. Bd3 d5 6. Nf3 c5`;
const moves = [
  'd4', 'Nf6', 'c4', 'e6', 'Nc3', 'Bb4', 'e3', 'O-O', 'Bd3', 'd5', 'Nf3', 'c5'
];

const moveExplanations = [
  "1.d4 Nf6: White controls the center with d4, Black responds with the Indian Defense.",
  "2.c4 e6: White expands on the queenside, Black prepares for central counterplay.",
  "3.Nc3 Bb4: White develops the knight, Black pins it with the bishop.",
  "4.e3 O-O: White prepares kingside development, Black castles for safety.",
  "5.Bd3 d5: White develops the bishop, Black challenges the center.",
  "6.Nf3 c5: White develops the kingside knight, Black prepares queenside expansion."
];
...
export default function OneD4RepertoireLesson() {
  ...
  return (
    <main className="min-h-screen bg-[var(--background)] text-[var(--primary-text)]">
      {/* Back Navigation Bar */}
      <div className="bg-gradient-to-r from-purple-600 to-indigo-600 text-[var(--card-foreground)] p-4 shadow-lg">
        <div className="max-w-7xl mx-auto flex items-center">
          <Link 
            href="/learn/courses/one-d4-repertoire" 
      ...
      {/* Header */}
      <div className="bg-gradient-to-r from-purple-600 to-indigo-600 text-[var(--card-foreground)] p-6">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-3xl font-bold mb-2">
            Lesson 1: One d4 Repertoire – Queen's Gambit
          </h1>
          <p className="text-purple-100">
            Master the solid d4 opening system
          </p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="h-[60vh] flex gap-6 p-6">
          ...
          <div className="w-3/5 bg-gradient-to-br from-purple-50 to-indigo-50 dark:from-purple-950/30 dark:to-indigo-950/30 rounded-2xl p-6 border border-[var(--border)] dark:border-purple-800 shadow-xl hover:shadow-2xl transition-all duration-300 flex flex-col justify-center items-center">
            <h3 className="text-xl font-bold mb-4 text-[var(--accent)] dark:text-purple-300 text-center">
            ...
            <div className="text-center mt-3">
              <div className="bg-[var(--card)] dark:bg-[var(--card)] rounded-lg px-4 py-2 shadow-md">
                <span className="text-sm font-semibold text-[var(--accent)] dark:text-purple-300">
          ...
          <div className="w-2/5 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-950/30 dark:to-indigo-950/30 rounded-2xl p-6 border border-[var(--border)] dark:border-blue-800 shadow-xl hover:shadow-2xl transition-all duration-300 flex flex-col">
            ...
            <div className="flex items-center mb-4">
              ...
              <div>
                <h2 className="text-xl font-bold text-[var(--accent)] dark:text-purple-300">
                  One d4 Repertoire
                </h2>
                <div className="flex gap-2 mt-1">
                  ...
                  <span className="bg-[var(--primary)] text-[var(--card-foreground)] px-2 py-1 rounded text-xs font-bold shadow-md">Repertoire</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-[var(--card)] dark:bg-[var(--card)] rounded-xl p-4 mb-4 shadow-lg">
              ...
              <p className="text-[var(--card-foreground)] dark:text-[var(--muted-foreground)] text-sm leading-relaxed mb-3">
                The d4 repertoire is a solid and flexible system that can lead to both tactical and positional games. This lesson teaches the fundamental ideas behind 1.d4 and how to handle various black responses.
              </p>
              
              {/* Theory Tips */}
              <div className="bg-gradient-to-r from-purple-50 to-indigo-50 dark:from-purple-900/20 dark:to-indigo-900/20 rounded-lg p-3">
                <h4 className="font-semibold text-purple-800 dark:text-purple-200 mb-2 text-sm">💡 Key Principles:</h4>
                <ul className="text-xs text-[var(--accent)] dark:text-purple-300 space-y-1">
