    ...
    <main className="min-h-screen bg-[var(--background)] text-[var(--primary-text)] px-4 py-10 flex justify-center">
      <div className="w-full max-w-[1200px] flex flex-row justify-center items-start gap-x-8">
        ...
        <div className="bg-[var(--card)] text-[var(--primary-text)] rounded-xl shadow-xl p-6 w-[400px] min-w-[400px] max-w-[400px] h-[540px] flex flex-col border border-[var(--border)]">
          <h1 className="text-3xl font-bold mb-4 text-[var(--primary-text)]">Lesson 2: Nimzo-Indian Defense – Control the Center</h1>
          ...
          <div className="flex-1 overflow-y-auto max-h-[220px] mb-4">
            <p className="text-lg leading-relaxed text-[var(--secondary-text)]">
              The Nimzo-Indian Defense is a flexible response by Black after 1.d4 Nf6 2.c4 e6 3.Nc3 Bb4. Black temporarily sacrifices the center to create doubled pawns and restrict White's long-term pawn structure. It's a key weapon against 1.d4 and teaches patience and precise play.
            </p>
            </div>
