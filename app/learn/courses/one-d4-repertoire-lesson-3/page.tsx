        ...
        <div className="bg-[var(--card)] rounded-xl shadow-lg p-8 flex flex-col justify-between">
          <div>
            ...
            <div className="flex gap-2 mb-4">
              <span className="bg-[var(--destructive)] text-[var(--card-foreground)] px-3 py-1 rounded text-sm font-bold">Advanced</span>
              <span className="bg-[var(--accent)] text-[var(--card-foreground)] px-3 py-1 rounded text-sm font-bold">Dynamic</span>
            </div>
