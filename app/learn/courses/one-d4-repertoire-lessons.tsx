...
const lessons = [
  {
    ...
    difficulty: "Easy",
    href: "/learn/courses/one-d4-repertoire-lesson-1",
  },
  {
    number: 2,
    title: 'Nimzo-Indian Defense – Control the Center',
    difficulty: 'Intermediate',
    href: '/learn/courses/one-d4-repertoire-lesson-2',
  },
  {
    number: 3,
    title: "King's Indian Defense – Break the Stronghold",
    difficulty: 'Advanced',
    href: '/learn/courses/one-d4-repertoire-lesson-3',
  },
];
  ...
  return (
    <main className="min-h-screen bg-[var(--background)] text-[var(--primary-text)] px-4 py-10 flex justify-center">
      <div className="max-w-2xl w-full">
        <h1 className="text-3xl font-bold mb-8">1.d4 Repertoire – Lessons</h1>
