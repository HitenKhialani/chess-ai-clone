  ...
  return (
    <main className="min-h-screen bg-[var(--background)] text-[var(--primary-text)] px-4 py-10 flex justify-center">
      <div className="max-w-7xl w-full grid grid-cols-1 md:grid-cols-3 md:[grid-template-columns:1fr_1fr_1fr] gap-8 items-start">
        ...
        <div className="bg-[var(--card)] rounded-xl shadow-lg p-8 flex flex-col h-full w-full min-w-[320px] min-h-[500px]">
        ...
        <div className="bg-[var(--card)] rounded-xl shadow-lg p-8 flex flex-col items-center h-full w-full min-w-[320px] min-h-[500px]">
          <ReactChessboard position={game.fen()} boardWidth={360} />
