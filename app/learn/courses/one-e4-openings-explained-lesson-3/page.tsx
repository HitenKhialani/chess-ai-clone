...
const theoryTips = [
  ...
  "⚡ Emphasize fast development and open lines",
  "🛡️ Accept unbalanced positions for initiative",
  "🎪 Prefer tactical sharpness over material",
  "📐 Launch kingside attacks with tempo"
];
      ...
      <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-[var(--card-foreground)] p-6">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-3xl font-bold mb-2">
            Lesson 3: King's Gambit – Sacrifice for Attack
          </h1>
            ...
            <div className="flex items-center mb-4">
              ...
              <div>
                ...
                <div className="flex gap-2 mt-1">
                  ...
                  <span className="bg-[var(--accent)] text-[var(--card-foreground)] px-2 py-1 rounded text-xs font-bold shadow-md">Sharp</span>
                </div>
              </div>
            </div>
