...
import { BookOpen, Clock, Target, CheckCircle, Star, Users, Trophy, Sparkles, Zap, ArrowLeft } from "lucide-react";
      ...
      <Card className="bg-[var(--card)] border-[var(--border)] hover:shadow-xl transition-all duration-300">
        <CardHeader>
          ...
          <CardDescription className="text-[var(--muted-foreground)] text-lg">
            Everything you need to know about the One e4 Openings Explained Course
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-8">
          ...
          <div className="bg-[var(--card)] rounded-lg p-6">
            <p className="text-[var(--primary-text)] leading-relaxed text-lg">
              Master the most popular opening move in chess - 1.e4! This course introduces you to 
              classical chess openings, focusing on controlling the center, rapid piece development, 
              and creating tactical opportunities. Learn the Italian Game, Scotch Game, and King's Gambit.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="flex justify-between items-center p-4 bg-[var(--secondary)] rounded-lg">
              ...
              <div className="bg-[var(--accent)] text-[var(--card-foreground)] px-3 py-1 rounded text-sm font-bold">Beginner to Intermediate</div>
            </div>
            <div className="flex justify-between items-center p-4 bg-[var(--secondary)] rounded-lg">
          ...
          <div className="bg-[var(--card)] rounded-lg p-6">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="font-semibold text-[var(--accent)]">Center Control</h4>
                  <p className="text-sm text-[var(--muted-foreground)]">Control the center with pawns and pieces</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="font-semibold text-[var(--accent)]">Rapid Development</h4>
                  <p className="text-sm text-[var(--muted-foreground)]">Master rapid piece development strategies</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="font-semibold text-[var(--accent)]">Tactical Opportunities</h4>
                  <p className="text-sm text-[var(--muted-foreground)]">Create tactical opportunities early</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
          ...
          <div>
                  <h4 className="font-semibold text-[var(--accent)]">Classical Principles</h4>
                  <p className="text-sm text-[var(--muted-foreground)]">Understand classical opening principles</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-[var(--card)] rounded-lg p-6">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              <div className="text-center p-4 bg-[var(--secondary)] rounded-lg">
                ...
                <h4 className="font-semibold text-[var(--accent)] mb-2">Classical Openings</h4>
                <p className="text-sm text-[var(--muted-foreground)]">Master the most popular opening move</p>
              </div>
              <div className="text-center p-4 bg-[var(--secondary)] rounded-lg">
                <div className="w-12 h-12 bg-[var(--accent)] text-[var(--card-foreground)] rounded-full flex items-center justify-center mx-auto mb-3">
                  <Sparkles className="w-6 h-6" />
                </div>
                <h4 className="font-semibold text-[var(--accent)] mb-2">Tactical Play</h4>
                <p className="text-sm text-[var(--muted-foreground)]">Develop sharp tactical awareness</p>
              </div>
              <div className="text-center p-4 bg-[var(--secondary)] rounded-lg">
                <div className="w-12 h-12 bg-[var(--accent)] text-[var(--card-foreground)] rounded-full flex items-center justify-center mx-auto mb-3">
                  <Sparkles className="w-6 h-6" />
                </div>
                <h4 className="font-semibold text-[var(--accent)] mb-2">Foundation Building</h4>
                <p className="text-sm text-[var(--muted-foreground)]">Build a solid opening foundation</p>
            </div>
          </div>
        </div>
