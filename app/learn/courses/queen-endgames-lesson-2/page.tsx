      ...
      <div className="bg-gradient-to-r from-pink-600 to-rose-600 text-[var(--card-foreground)] p-6">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-3xl font-bold mb-2">
            Lesson 2: Queen vs Rook – The Art of Conversion
          </h1>
          <p className="text-pink-100">
            Convert Q vs R by avoiding stalemates and using winning patterns.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="h-[60vh] flex gap-6 p-6">
          ...
          <div className="w-3/5 bg-gradient-to-br from-pink-50 to-rose-50 dark:from-pink-950/30 dark:to-rose-950/30 rounded-2xl p-6 border border-[var(--border)] dark:border-pink-800 shadow-xl hover:shadow-2xl transition-all duration-300 flex flex-col justify-center items-center">
            <h3 className="text-xl font-bold mb-4 text-[var(--accent)] dark:text-pink-300 text-center">Interactive Chess Board</h3>
            ...
            <div className="text-center mt-3">
              <div className="bg-[var(--card)] dark:bg-[var(--card)] rounded-lg px-4 py-2 shadow-md">
                <span className="text-sm font-semibold text-[var(--accent)] dark:text-pink-300">Move {moveIdx} of {moves.length}</span>
              </div>
            </div>
          </div>
          ...
          <div className="w-2/5 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-950/30 dark:to-indigo-950/30 rounded-2xl p-6 border border-[var(--border)] dark:border-blue-800 shadow-xl hover:shadow-2xl transition-all duration-300 flex flex-col">
            <div className="flex items-center mb-4">
              <div className="w-12 h-12 bg-[var(--accent)] text-[var(--card-foreground)] rounded-full flex items-center justify-center text-lg font-bold mr-3 shadow-lg">2</div>
              <div>
                <h2 className="text-xl font-bold text-[var(--accent)] dark:text-pink-300">Queen vs Rook</h2>
            ...
            <div className="bg-[var(--card)] dark:bg-[var(--card)] rounded-xl p-4 mb-4 shadow-lg">
              ...
              <p className="text-[var(--card-foreground)] dark:text-[var(--muted-foreground)] text-sm leading-relaxed mb-3">Converting a queen vs rook endgame is tricky. Learn the winning techniques, including the "box" and "second rank defense." Practice patience and precision to avoid stalemates and win the full point.</p>
            </div>
          ...
          <div className="flex gap-4 overflow-x-auto pb-4 scrollbar-thin scrollbar-thumb-purple-300 scrollbar-track-purple-100 dark:scrollbar-thumb-purple-600 dark:scrollbar-track-purple-900">
            {moveExplanations.map((explanation, index) => (
              <div
                ...
                className={`flex-shrink-0 w-80 bg-[var(--card)] dark:bg-[var(--card)] rounded-xl p-4 cursor-pointer transition-all duration-300 hover:shadow-xl transform hover:scale-105 border-2 ${index === moveIdx - 1 ? 'ring-2 ring-blue-500 shadow-xl border-blue-300' : 'hover:ring-1 hover:ring-purple-300 border-transparent hover:border-[var(--border)]'}`}
              >
                <div className="flex items-center mb-3">
                  <div className={`${index === moveIdx - 1 ? 'bg-[var(--card)]0' : 'bg-[var(--accent)]'} w-10 h-10 rounded-full flex items-center justify-center text-[var(--accent-foreground)] font-bold mr-3 shadow-lg`}>{index + 1}</div>
                ...
                <div className="flex justify-between items-center">
                  <span className="text-xs text-[var(--accent)] dark:text-purple-400 font-medium bg-[var(--secondary)] dark:bg-purple-900 px-2 py-1 rounded">{moves[index]}</span>
