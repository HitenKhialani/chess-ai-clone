    ...
    <main className="min-h-screen bg-[var(--background)] text-[var(--primary-text)]">
      ...
      <div className="bg-gradient-to-r from-pink-600 to-rose-600 text-[var(--card-foreground)] p-6">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-pink-100">Handle perpetuals, avoid stalemates, and convert queen endgames cleanly.</p>
        </div>
      </div>
        ...
        <div className="h-[60vh] flex gap-6 p-6">
          ...
          <div className="w-2/5 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-950/30 dark:to-indigo-950/30 rounded-2xl p-6 border border-[var(--border)] dark:border-blue-800 shadow-xl hover:shadow-2xl transition-all duration-300 flex flex-col">
            <div className="flex items-center mb-4">
              <div className="w-12 h-12 bg-[var(--accent)] text-[var(--card-foreground)] rounded-full flex items-center justify-center text-lg font-bold mr-3 shadow-lg">3</div>
              <div>
                <h2 className="text-xl font-bold text-[var(--accent)] dark:text-pink-300">Perpetuals & Stalemates</h2>
            ...
            <div className="bg-[var(--card)] dark:bg-[var(--card)] rounded-xl p-4 mb-4 shadow-lg">
              ...
              <p className="text-[var(--card-foreground)] dark:text-[var(--muted-foreground)] text-sm leading-relaxed mb-3">Queen endgames are full of tricks. Learn to use perpetual check, avoid stalemates, and convert advantages. Understanding perpetuals and stalemate motifs is key to practical queen endgame play.</p>
            </div>
