...
export default function QueenEndgamesLesson3() {
    ...
    <main className="min-h-screen bg-[var(--background)] text-[var(--primary-text)] px-4 py-10 flex justify-center">
      <div className="w-full max-w-[1200px] flex flex-row justify-center items-start gap-x-8">
        ...
        <div className="bg-[var(--card)] text-[var(--primary-text)] rounded-xl shadow-xl p-6 w-[400px] min-w-[400px] max-w-[400px] h-[540px] flex flex-col border border-[var(--border)]">
          ...
          <h1 className="text-3xl font-bold mb-2 text-[var(--primary-text)]">Lesson 3: Queen Endgames</h1>
          <div className="flex-1 overflow-y-auto mb-4">
            <p className="text-base text-[var(--secondary-text)]">
              Learn how to handle queen endgames with accuracy and confidence. This lesson covers key checkmating patterns, perpetual checks, and how to avoid stalemates in high-pressure situations.
            </p>
            <h2 className="font-bold text-base mb-1 mt-2 text-[var(--primary-text)]">Fundamentals (Chess Trainer Explanation)</h2>
            <p className="mb-2 text-[var(--secondary-text)]">Queen endgames require precision. Learn to use your queen to check, restrict the enemy king, and force favorable exchanges.</p>
          </div>
