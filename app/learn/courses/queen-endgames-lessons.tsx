...
const lessons = [
  {
    number: 1,
    title: 'Perpetual Check – Forcing Draws',
    difficulty: 'Easy',
    href: '/learn/courses/queen-endgames-lesson-1',
  },
  {
    number: 2,
    title: 'Pawn Race Endgames – Speed vs. Defense',
    difficulty: 'Intermediate',
    href: '/learn/courses/queen-endgames-lesson-2',
  },
  {
    number: 3,
    title: 'Centralization – Power of the Queen',
    difficulty: 'Advanced',
    href: '/learn/courses/queen-endgames-lesson-3',
  },
];
  ...
  return (
    <main className="min-h-screen bg-[var(--background)] text-[var(--primary-text)] px-4 py-10 flex justify-center">
      <div className="max-w-2xl w-full">
        <h1 className="text-3xl font-bold mb-8">Queen Endgames – Lessons</h1>
