...
import { BookOpen, Clock, Target, CheckCircle, Star, Users, Trophy, Sparkles, Crown, ArrowLeft } from "lucide-react";
      ...
      <Card className="bg-[var(--card)] border-[var(--border)] hover:shadow-xl transition-all duration-300">
        <CardHeader>
          ...
          <CardDescription className="text-[var(--muted-foreground)] text-lg">
            Everything you need to know about the Queen Endgames Course
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-8">
          ...
          <div className="bg-[var(--card)] rounded-lg p-6">
            <p className="text-[var(--primary-text)] leading-relaxed text-lg">
              Master the most powerful piece in chess - the queen! Learn how to win with queen advantage, 
              handle queen vs queen positions, and understand the key principles that make queen endgames 
          ...
          <div className="bg-[var(--card)] rounded-lg p-6">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="font-semibold text-[var(--accent)]">Queen Advantage</h4>
                  <p className="text-sm text-[var(--muted-foreground)]">Learn to win with queen advantage</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="font-semibold text-[var(--accent)]">Queen vs Queen</h4>
                  <p className="text-sm text-[var(--muted-foreground)]">Master queen vs queen positions</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="font-semibold text-[var(--accent)]">Checkmate Patterns</h4>
                  <p className="text-sm text-[var(--muted-foreground)]">Learn queen checkmate patterns</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="font-semibold text-[var(--accent)]">Endgame Principles</h4>
                  <p className="text-sm text-[var(--muted-foreground)]">Understand queen endgame principles</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-[var(--card)] rounded-lg p-6">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              <div className="text-center p-4 bg-[var(--secondary)] rounded-lg">
                ...
                <h4 className="font-semibold text-[var(--accent)] mb-2">Queen Mastery</h4>
                <p className="text-sm text-[var(--muted-foreground)]">Master the most powerful piece</p>
              </div>
              <div className="text-center p-4 bg-[var(--secondary)] rounded-lg">
                <div className="w-12 h-12 bg-[var(--accent)] text-[var(--card-foreground)] rounded-full flex items-center justify-center mx-auto mb-3">
                  <Sparkles className="w-6 h-6" />
                </div>
                <h4 className="font-semibold text-[var(--accent)] mb-2">Endgame Excellence</h4>
                <p className="text-sm text-[var(--muted-foreground)]">Develop advanced endgame skills</p>
              </div>
              <div className="text-center p-4 bg-[var(--secondary)] rounded-lg">
                <div className="w-12 h-12 bg-[var(--accent)] text-[var(--card-foreground)] rounded-full flex items-center justify-center mx-auto mb-3">
                  <Sparkles className="w-6 h-6" />
                </div>
                <h4 className="font-semibold text-[var(--accent)] mb-2">Checkmate Skills</h4>
                <p className="text-sm text-[var(--muted-foreground)]">Learn powerful checkmate patterns</p>
          </div>
        </div>
      </div>
          ...
          <div className="bg-gradient-to-r from-[var(--accent)] to-[var(--accent-soft)] p-8 rounded-2xl text-center">
            ...
            <Link href="/learn/courses/queen-endgames-lesson-1">
