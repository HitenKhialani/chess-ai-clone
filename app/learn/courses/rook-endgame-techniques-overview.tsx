...
import { BookOpen, Clock, Target, CheckCircle, Star, Users, Trophy, Sparkles, Castle, ArrowLeft } from "lucide-react";
      ...
      <Card className="bg-[var(--card)] border-[var(--border)] hover:shadow-xl transition-all duration-300">
        <CardHeader>
          ...
          <CardDescription className="text-[var(--muted-foreground)] text-lg">
            Everything you need to know about the Rook Endgame Techniques Course
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-8">
          ...
          <div className="bg-[var(--card)] rounded-lg p-6">
            <p className="text-[var(--primary-text)] leading-relaxed text-lg">
              Master the most common endgame in chess - rook endgames! Learn how to win with rook advantage, 
              handle rook vs rook positions, and understand the key techniques that make rook endgames 
              both practical and essential for every chess player.
            </p>
          </div>
          ...
          <div className="bg-[var(--card)] rounded-lg p-6">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="font-semibold text-[var(--accent)]">Rook Advantage</h4>
                  <p className="text-sm text-[var(--muted-foreground)]">Learn to win with rook advantage</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="font-semibold text-[var(--accent)]">Rook vs Rook</h4>
                  <p className="text-sm text-[var(--muted-foreground)]">Master rook vs rook positions</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="font-semibold text-[var(--accent)]">Practical Techniques</h4>
                  <p className="text-sm text-[var(--muted-foreground)]">Learn practical rook endgame techniques</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-[var(--muted-foreground)]">Understand rook endgame principles</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-[var(--card)] rounded-lg p-6">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              <div className="text-center p-4 bg-[var(--secondary)] rounded-lg">
                ...
                <h4 className="font-semibold text-[var(--accent)] mb-2">Rook Mastery</h4>
                <p className="text-sm text-[var(--muted-foreground)]">Master the most common endgame</p>
              </div>
              <div className="text-center p-4 bg-[var(--secondary)] rounded-lg">
                <div className="w-12 h-12 bg-[var(--accent)] text-[var(--card-foreground)] rounded-full flex items-center justify-center mx-auto mb-3">
                ...
                <p className="text-sm text-[var(--muted-foreground)]">Develop practical endgame skills</p>
              </div>
              <div className="text-center p-4 bg-[var(--secondary)] rounded-lg">
                <div className="w-12 h-12 bg-[var(--accent)] text-[var(--card-foreground)] rounded-full flex items-center justify-center mx-auto mb-3">
                  <Sparkles className="w-6 h-6" />
                </div>
                <h4 className="font-semibold text-[var(--accent)] mb-2">Essential Knowledge</h4>
                <p className="text-sm text-[var(--muted-foreground)]">Learn essential endgame knowledge</p>
          </div>
        </div>
      </div>
