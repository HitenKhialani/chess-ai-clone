...
const moveExplanations = [
  "1.e4 c5: Sicilian start - Black immediately contests the center with c5.",
  ...
  "5.Nc3 a6: White supports the center - Black prepares b5 and flexible setups."
];
      ...
      <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-[var(--card-foreground)] p-6">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-3xl font-bold mb-2">
            Lesson 1: Najdorf Variation – Dynamic Counterplay
          </h1>
          <p className="text-blue-100">
            Master the Najdorf Variation with its dynamic counterplay and complex strategic themes
          </p>
        </div>
      </div>
