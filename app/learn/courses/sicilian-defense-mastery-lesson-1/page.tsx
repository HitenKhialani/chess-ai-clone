    ...
    <main className="min-h-screen bg-[var(--background)] text-[var(--primary-text)] px-4 py-10 flex justify-center">
      <div className="w-full max-w-[1200px] flex flex-row justify-center items-start gap-x-8">
        ...
        <div className="bg-[var(--card)] text-[var(--primary-text)] rounded-xl shadow-xl p-6 w-[400px] min-w-[400px] max-w-[400px] h-[540px] flex flex-col border border-[var(--border)]">
          ...
          <h1 className="text-3xl font-bold mb-2 text-[var(--primary-text)]">Lesson 1: Najdorf Variation – Dynamic Counterplay</h1>
          <div className="flex-1 overflow-y-auto mb-4">
            <p className="text-base text-[var(--secondary-text)]">
              The Najdorf Variation is a powerful response to 1.e4 that provides Black with active play and kingside counterattacks. Players learn to create long-term imbalances, launch pawn storms, and develop quickly for dynamic attacks.
            </p>
            <h2 className="font-bold text-base mb-1 mt-2 text-[var(--primary-text)]">Fundamentals (Chess Trainer Explanation)</h2>
            <p className="mb-2 text-[var(--secondary-text)]">The Najdorf Variation is a powerful response to 1.e4 that provides Black with active play and kingside counterattacks. Players learn to create long-term imbalances, launch pawn storms, and develop quickly for dynamic attacks.</p>
          </div>
