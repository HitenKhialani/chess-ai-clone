...
const PGN = `1.e4 c5 2.Nf3 d6 3.d4 cxd4 4.Nxd4 Nf6 5.Nc3 g6 6.Be3 Bg7 7.f3 O-O 8.Qd2 Nc6 9.O-O-O`;
...
const moveExplanations = [
  ...
  "2.Nf3 d6: White develops and prepares d4 - Black supports c5 and prepares Nf6.",
  "3.d4 cxd4: White strikes in the center - Black exchanges to maintain control.",
  ...
  "8.Qd2 Nc6: White prepares queenside castling - Black develops.",
  "9.O-O-O: White castles queenside - ready to launch a kingside attack."
];

const theoryTips = [
  "🎯 Fianchetto the dark-squared bishop for long diagonal control",
  "⚡ Play for opposite-side castling and pawn storms",
  "🛡️ Both sides play for direct attacks",
  "🎪 Precise calculation is critical in tactical positions",
      ...
      <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-[var(--card-foreground)] p-6">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-3xl font-bold mb-2">
            Lesson 2: Dragon Variation – Sharp Tactical Play
          </h1>
          <p className="text-blue-100">
            Explore the sharp Dragon Variation with its tactical opportunities and attacking themes
          </p>
        </div>
      </div>
          ...
          <div className="w-full lg:w-2/5 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-950/30 dark:to-indigo-950/30 rounded-2xl p-6 border border-[var(--border)] dark:border-blue-800 shadow-xl hover:shadow-2xl transition-all duration-300 flex flex-col">
            ...
            <div className="flex items-center mb-4">
              ...
              <div>
                ...
                <div className="flex gap-2 mt-1">
                  ...
                  <span className="bg-[var(--primary)] text-[var(--card-foreground)] px-2 py-1 rounded text-xs font-bold shadow-md">Tactical</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-[var(--card)] dark:bg-[var(--card)] rounded-xl p-4 mb-4 shadow-lg">
              ...
              <p className="text-[var(--card-foreground)] dark:text-[var(--muted-foreground)] text-sm leading-relaxed mb-3">
                The Dragon Variation is one of the sharpest lines in the Sicilian, leading to rich tactical battles and opposite-side castling attacks. Black fianchettos the dark-squared bishop, leading to dynamic play and opposite-side castling. Both sides play for direct attacks; precise calculation is critical.
              </p>
