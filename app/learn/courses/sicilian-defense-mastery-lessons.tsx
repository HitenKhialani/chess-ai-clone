...
const lessons = [
  {
    ...
    difficulty: 'Easy',
    href: '/learn/courses/sicilian-defense-mastery-lesson-1',
  },
  {
    number: 2,
    title: 'Dragon Variation – Sharp Tactical Play',
    difficulty: 'Intermediate',
    href: '/learn/courses/sicilian-defense-mastery-lesson-2',
  },
  {
    number: 3,
    title: 'Accelerated Dragon – Fast Development',
    difficulty: 'Advanced',
    href: '/learn/courses/sicilian-defense-mastery-lesson-3',
  },
];
  ...
  return (
    <main className="min-h-screen bg-[var(--background)] text-[var(--primary-text)] px-4 py-10 flex justify-center">
      <div className="max-w-2xl w-full">
        <h1 className="text-3xl font-bold mb-8">Sicilian Defense Mastery – Lessons</h1>
