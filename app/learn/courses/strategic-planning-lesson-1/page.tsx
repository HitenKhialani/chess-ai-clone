      ...
      <div className="max-w-7xl w-full grid grid-cols-1 md:grid-cols-3 md:[grid-template-columns:1fr_1fr_1fr] gap-8 items-start">
        ...
        <div className="bg-[var(--card)] rounded-xl shadow-lg p-8 max-w-xl w-full mt-8">
          ...
          <div className="mb-4">
            ...
            <div className="bg-[var(--background)] text-green-200 rounded px-3 py-2 text-sm font-mono mb-2">1. e4 e6 2. d4 d5 3. Nc3 Nf6 4. Nf3 Bb4 5. e5 Ne4 6. Bd2 Nxd2 7. Qxd2 c5 8. a3 Ba5 9. dxc5 Nc6</div>
          </div>
          <div>
