...
export default function StrategicPlanningLesson2() {
      ...
      <div className="w-full max-w-[1200px] flex flex-row justify-center items-start gap-x-8">
        ...
        <div className="bg-[var(--card)] text-[var(--primary-text)] rounded-xl shadow-xl p-6 w-[400px] min-w-[400px] max-w-[400px] h-[540px] flex flex-col border border-[var(--border)]">
          <div className="flex gap-2 mb-2">
            ...
            <span className="bg-blue-600 text-xs font-bold text-white px-2 py-1 rounded">Strategy</span>
          </div>
          <h1 className="text-3xl font-bold mb-2 text-[var(--primary-text)]">Lesson 2: Strategic Planning</h1>
          <div className="flex-1 overflow-y-auto mb-4">
            <p className="text-base text-[var(--secondary-text)]">
              Strategy is the backbone of successful chess play. This lesson focuses on long-term planning, pawn structure manipulation, and understanding key positional principles that win games.
            </p>
            <h2 className="font-bold text-base mb-1 mt-2 text-[var(--primary-text)]">Fundamentals (Chess Trainer Explanation)</h2>
            <p className="mb-2 text-[var(--secondary-text)]">Learn to create plans, improve your worst piece, and use pawn breaks to open lines at the right moment.</p>
          </div>
