...
const lessons = [
  {
    ...
    difficulty: 'Easy',
    href: '/learn/courses/strategic-planning-lesson-1',
  },
  {
    number: 2,
    title: 'Strong Outposts and Piece Maneuvering',
    difficulty: 'Intermediate',
    href: '/learn/courses/strategic-planning-lesson-2',
  },
  {
    number: 3,
    title: 'Color Complexes and Long-Term Advantages',
    difficulty: 'Advanced',
    href: '/learn/courses/strategic-planning-lesson-3',
  },
];
  ...
  return (
    <main className="min-h-screen bg-[var(--background)] text-[var(--primary-text)] px-4 py-10 flex justify-center">
      <div className="max-w-2xl w-full">
        <h1 className="text-3xl font-bold mb-8">Strategic Planning – Lessons</h1>
