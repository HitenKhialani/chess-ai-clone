  ...
  return (
    <main className="min-h-screen bg-[var(--background)] relative overflow-hidden">
      ...
      <div className="max-w-screen-xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row justify-center gap-8">
          <div className="flex gap-2 justify-center mt-4 w-full">
            ...
            <Button className="bg-[var(--accent)] text-white border border-[var(--border)] hover:bg-[#B5532A] btn-glow" onClick={resetGame}>New Game</Button>
            <Button
              className="bg-[var(--accent)] text-white border border-[var(--border)] hover:bg-[#B5532A] btn-glow"
              variant="outline"
        ...
        {showAnalysis && (
          <div className="flex flex-col items-center">
            ...
            <div className="flex justify-center lg:justify-start mt-4">
              <Card className="w-full max-w-md bg-[var(--card)] border border-[var(--border)] shadow-lg">
      ...
      <Dialog open={showCheckmate} onOpenChange={setShowCheckmate}>
        <DialogContent className="max-w-md w-full rounded-2xl p-8 bg-[var(--card)] border border-[var(--border)] text-center">
          <DialogHeader>
            ...
            <DialogDescription className="text-lg mb-4 text-[var(--primary-text)]">
            ...
            <div className="flex flex-col items-center gap-2 mb-4">
              <div className="flex justify-between w-full text-sm">
                <span className="font-semibold text-[var(--accent)]">Opponent:</span>
                <span className="font-bold text-[var(--primary-text)]">{name}</span>
              </div>
              <div className="flex justify-between w-full text-sm">
                <span className="font-semibold text-[var(--accent)]">Your Rating:</span>
                <span className="font-bold text-[var(--primary-text)]">{rating}</span>
              </div>
              <div className="flex justify-between w-full text-sm">
                <span className="font-semibent text-[var(--accent)]">Accuracy:</span>
                <span className="font-bold text-[var(--accent)]">{accuracy}%</span>
              </div>
            </div>
          </DialogHeader>
          <DialogFooter className="flex flex-row gap-4 justify-center mt-4">
            <Button className="bg-[var(--accent)] hover:bg-[#B5532A] text-white font-bold px-6 py-2 rounded-lg" onClick={() => { setShowCheckmate(false); setShowGameReview(true); }}>Start Review</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
