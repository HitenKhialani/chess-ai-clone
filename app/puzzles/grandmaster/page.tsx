...
export default function GrandmasterPuzzles() {
  ...
  if (!currentPuzzle || !selectedGM) {
    return (
      <div className="min-h-screen bg-[var(--background)] text-[var(--card-foreground)] p-4 md:p-8 flex items-center justify-center">
  ...
  return (
    <div className="min-h-screen bg-[var(--background)] text-[var(--card-foreground)] p-4 md:p-8">
      ...
      <div className="max-w-7xl mx-auto">
        <Tab.Group onChange={(index: number) => {
          ...
          <Tab.List className="flex space-x-1 rounded-xl bg-[var(--card)] p-1 mb-8">
                  ...
                  <div className="flex justify-center">
                    <PuzzleBoard
                      ...
                      onComplete={() => {
                        ...
                        if (token && currentPuzzle && currentPuzzle.fen) {
                          fetch(`${backendUrl}/api/users/solve-puzzle`, {
                            ...
                            body: JSON.stringify({ puzzle_id: currentPuzzle.fen, category: 'Grandmaster' }),
                          });
                        }
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex justify-between">
                      <button
                        ...
                        className="px-4 py-2 bg-[var(--accent)] rounded-lg disabled:opacity-50 disabled:cursor-not-allowed hover:bg-[var(--accent)] hover:opacity-80"
                      >
                        Previous Puzzle
                      </button>
                      <button
