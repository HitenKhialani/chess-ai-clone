...
export default function PuzzlesPage() {
  ...
  const loadPuzzle = async (idx: number) => {
    ...
    setError(null)
    try {
      const response = await fetch(`/api/puzzles/pgn/by-theme/${encodeURIComponent('Mate in 2')}/by-index/${idx}`)
  ...
  const handleNextPuzzle = () => {
    ...
    if (token && puzzle && puzzle.id) {
      fetch(`${backendUrl}/api/users/solve-puzzle`, {
        ...
        body: JSON.stringify({ puzzle_id: puzzle.id, category: 'Mate in 2' }),
      });
    }
    if (currentIndex + 1 < totalPuzzles) {
      ...
      setCompleted(true)
      toast.success('You solved all the mate in 2 puzzles!')
    }
  }
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center gap-3 mb-2">
            <div>
              <h1 className="text-4xl font-bold bg-gradient-to-r from-[#F59E0B] to-[#F97316] bg-clip-text text-transparent">
                Mate in 2 Puzzles
              </h1>
              <p className="text-[var(--muted-foreground)] mt-1">Intermediate puzzles to find a forced mate in two moves</p>
            </div>
          </div>
        </div>
            ...
            {loading ? (
              ...
              <div className="glass-effect rounded-xl p-8 border border-[var(--border)]/10">
                <div className="flex flex-col items-center justify-center h-96 gap-4 text-center">
                  ...
                  <Button 
                    onClick={handleRetry} 
                    className="bg-gradient-to-r from-[#F59E0B] to-[#F97316] hover:from-[#F59E0B]/90 hover:to-[#F97316]/90 text-[var(--card-foreground)] rounded-lg px-6 py-2 font-bold shadow-lg hover:shadow-[#F59E0B]/25 transition-all duration-300"
                  >
              ...
              <div className="glass-effect rounded-xl p-8 border border-[var(--border)]/10">
                <div className="flex flex-col items-center justify-center h-96 gap-6 text-center">
                  <div className="p-4 rounded-full bg-gradient-to-r from-orange-500/20 to-amber-500/20 border border-orange-500/30">
                    <CheckCircle className="w-12 h-12 text-orange-400" />
                  </div>
                  <div>
                    <h2 className="text-3xl font-bold text-orange-400 mb-2">Great work!</h2>
                  ...
                  <Button 
                    ...
                    className="bg-gradient-to-r from-[#F59E0B] to-[#F97316] hover:from-[#F59E0B]/90 hover:to-[#F97316]/90 text-[var(--card-foreground)] rounded-lg px-8 py-3 font-bold shadow-lg hover:shadow-[#F59E0B]/25 transition-all duration-300"
                  >
                    Restart Puzzles
                  </Button>
                </div>
          ...
          <div className="lg:col-span-1">
            <div className="glass-effect rounded-xl p-6 border border-[var(--border)]/10 mb-6">
              <div className="flex items-center gap-3 mb-4">
                <div className="p-2 rounded-lg bg-gradient-to-r from-[#F59E0B]/20 to-[#F97316]/20">
                  <Target className="w-5 h-5 text-[#F59E0B]" />
                </div>
                <div>
                  <h3 className="text-xl font-bold text-[var(--card-foreground)]">Two-Move Mates</h3>
              ...
              <p className="text-[var(--muted-foreground)] mb-4 text-sm leading-relaxed">
                Find the sequence that forces checkmate in two moves. Look for forcing checks and calculated threats.
              </p>
              ...
              <div className="mb-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="text-center p-3 rounded-lg bg-[var(--card)]/50 border border-gray-700/50">
                    <div className="text-2xl font-bold text-[#F59E0B]">{completed ? totalPuzzles : currentIndex + 1}</div>
              ...
              {showExplanation && (
                <div className="glass-effect rounded-lg p-4 border border-[#F59E0B]/20">
                  <div className="flex items-center gap-2 mb-3">
                    <Trophy className="w-5 h-5 text-[#F59E0B]" />
                    <h4 className="font-bold text-[var(--card-foreground)]">Solution</h4>
                  </div>
                  <div className="mb-2">
                    <span className="font-mono font-bold text-xl text-[#F59E0B]">{solutionMove}</span>
                  </div>
                  <p className="text-[var(--muted-foreground)] text-sm">
                    This puzzle requires a forcing first move that creates unavoidable mate threats on the next move.
                  </p>
                </div>
              )}
            </div>
            ...
            <div className="glass-effect rounded-xl p-6 border border-[var(--border)]/10">
              ...
              <blockquote className="text-[#F59E0B] font-bold text-lg mb-2">
                "Tactics flow from a superior position." – Bobby Fischer
              </blockquote>
              <p className="text-[var(--muted-foreground)] text-sm">
                Keep practicing calculation depth and forcing sequences.
              </p>
            </div>
          </div>
        </div>
