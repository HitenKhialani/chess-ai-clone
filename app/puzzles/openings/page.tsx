              ...
              <CardContent className="p-6">
                <Tabs defaultValue="sicilian" className="space-y-4">
                  <TabsList className="bg-[#121212] border-b border-[#3F51B5]">
                    <TabsTrigger 
                      value="sicilian"
                      className="data-[state=active]:bg-[#3F51B5] data-[state=active]:text-[var(--card-foreground)]"
                    >
                      Sicilian
                    </TabsTrigger>
                    <TabsTrigger 
                      ...
                      <div className="space-y-4">
                        ...
                        <PuzzleBoard
                          ...
                          onComplete={() => {
                            ...
                            if (token && position && position.fen) {
                              fetch(`${backendUrl}/api/users/solve-puzzle`, {
                                ...
                                body: JSON.stringify({ puzzle_id: position.fen, category: 'Openings' }),
                              });
                            }
