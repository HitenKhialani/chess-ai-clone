        ...
        <div className="flex-1 max-w-md w-full">
          <div className="bg-[#192133] border border-[#232a3b] rounded-xl shadow-xl p-6 mb-4">
            <div className="flex items-center gap-2 mb-2">
              <span className="font-bold text-lg text-[var(--primary-text)] dark:text-purple-200">Pin Puzzle</span>
            ...
            <div className="text-gray-700 dark:text-gray-300 mb-2 text-sm">Practice pin tactics to win material or create threats.</div>
