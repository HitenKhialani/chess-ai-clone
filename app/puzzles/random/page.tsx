      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-4 mb-4">
            <Link href="/puzzles" className="flex items-center gap-2 text-[var(--muted-foreground)] hover:text-gray-200 transition-colors duration-300">
          ...
          <div className="flex items-center gap-3 mb-2">
            <div>
              ...
              <p className="text-[var(--muted-foreground)] mt-1">A diverse mix of puzzles to test your overall skills</p>
            </div>
          </div>
        </div>
            ...
            {loading ? (
              ...
              <div className="glass-effect rounded-xl p-8 border border-[var(--border)]/10">
                <div className="flex flex-col items-center justify-center h-96 gap-4 text-center">
                  ...
                  <Button 
                    onClick={handleRetry} 
                    className="bg-gradient-to-r from-gray-500 to-slate-500 hover:from-gray-600 hover:to-slate-600 text-[var(--card-foreground)] rounded-lg px-6 py-2 font-bold shadow-lg hover:shadow-gray-500/25 transition-all duration-300"
                  >
              ...
              <div className="glass-effect rounded-xl p-8 border border-[var(--border)]/10">
                <div className="flex flex-col items-center justify-center h-96 gap-6 text-center">
                  ...
                  <Button 
                    ...
                    className="bg-gradient-to-r from-gray-500 to-slate-500 hover:from-gray-600 hover:to-slate-600 text-[var(--card-foreground)] rounded-lg px-8 py-3 font-bold shadow-lg hover:shadow-gray-500/25 transition-all duration-300"
                  >
                    Restart Puzzles
                  </Button>
                </div>
            ...
            <div className="glass-effect rounded-xl p-6 border border-[var(--border)]/10 mb-6">
              <div className="flex items-center gap-3 mb-4">
                <div className="p-2 rounded-lg bg-gradient-to-r from-gray-500/20 to-slate-500/20">
                  <Brain className="w-5 h-5 text-[var(--muted-foreground)]" />
                </div>
                <div>
                  <h3 className="text-lg font-bold text-[var(--card-foreground)]">Random Puzzles</h3>
                  <Badge className="bg-[var(--destructive)]/20 text-red-400 border-red-500/30 mt-1">Advanced</Badge>
                </div>
              </div>
              <p className="text-[var(--muted-foreground)] text-sm mb-4">
                A diverse mix of puzzles to test your overall skills. Challenge yourself with various tactical and strategic positions.
              </p>
              <div className="flex items-center gap-2 text-[var(--muted-foreground)] mb-3">
                <span className="text-sm font-medium">RANDOM PUZZLES</span>
            ...
            {showExplanation && (
              <div className="glass-effect rounded-xl p-6 border border-[var(--border)]/10 mb-6">
                ...
                <p className="text-[var(--muted-foreground)] text-sm mb-3">
                  The best move is: <span className="font-mono text-[var(--muted-foreground)]">{solutionMove}</span>
                </p>
                <p className="text-[var(--muted-foreground)] text-xs">
                  This move demonstrates a key tactical or strategic concept that can be applied in similar positions.
                </p>
              </div>
            )}
