  ...
  const handleNextPuzzle = () => {
    ...
    if (token && puzzle && puzzle.fen) {
      fetch(`${backendUrl}/api/users/solve-puzzle`, {
        ...
        body: JSON.stringify({ puzzle_id: puzzle.fen, category: 'Tactics' }),
      });
    }
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-4 mb-4">
            <Link href="/puzzles" className="flex items-center gap-2 text-green-300 hover:text-green-200 transition-colors duration-300">
          ...
          <div className="flex items-center gap-3 mb-2">
            <div>
              ...
              <p className="text-[var(--muted-foreground)] mt-1">Sharpen your tactical vision with complex combinations</p>
            </div>
          </div>
        </div>
            ...
            {loading ? (
              ...
              <div className="glass-effect rounded-xl p-8 border border-[var(--border)]/10">
                <div className="flex flex-col items-center justify-center h-96 gap-4 text-center">
                  ...
                  <Button 
                    onClick={handleRetry} 
                    className="bg-gradient-to-r from-green-500 to-emerald-500 hover:from-green-600 hover:to-emerald-600 text-[var(--card-foreground)] rounded-lg px-6 py-2 font-bold shadow-lg hover:shadow-green-500/25 transition-all duration-300"
                  >
              ...
              <div className="glass-effect rounded-xl p-8 border border-[var(--border)]/10">
                <div className="flex flex-col items-center justify-center h-96 gap-6 text-center">
                  ...
                  <Button 
                    ...
                    className="bg-gradient-to-r from-green-500 to-emerald-500 hover:from-green-600 hover:to-emerald-600 text-[var(--card-foreground)] rounded-lg px-8 py-3 font-bold shadow-lg hover:shadow-green-500/25 transition-all duration-300"
                  >
                    Restart Puzzles
                  </Button>
                </div>
          ...
          <div className="lg:col-span-1">
            <div className="glass-effect rounded-xl p-6 border border-[var(--border)]/10 mb-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <h3 className="text-lg font-bold text-[var(--card-foreground)]">Tactical Puzzles</h3>
                  <Badge className="bg-yellow-500/20 text-yellow-400 border-yellow-500/30 mt-1">Intermediate</Badge>
                </div>
              </div>
              <p className="text-[var(--muted-foreground)] text-sm mb-4">
                Sharpen your tactical vision with complex combinations. Master advanced tactical patterns and combinations.
              </p>
              <div className="flex items-center gap-2 text-[var(--muted-foreground)] mb-3">
                <span className="text-sm font-medium">TACTICAL PUZZLES</span>
            ...
            {showExplanation && (
              <div className="glass-effect rounded-xl p-6 border border-[var(--border)]/10 mb-6">
                ...
                <p className="text-[var(--muted-foreground)] text-sm mb-3">
                  The best move is: <span className="font-mono text-green-400">{solutionMove}</span>
                </p>
                <p className="text-[var(--muted-foreground)] text-xs">
                  This tactical combination creates multiple threats and forces your opponent into a difficult position.
                </p>
              </div>
            )}
