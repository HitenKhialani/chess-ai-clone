...
const simploChatRoutes = require('./routes/simploChatRoutes');
...
const MONGODB_URI = process.env.MONGODB_URI || 'mongodb+srv://co2023yashkhanvilkar:906472@chess-training-cluster.5nq1gpd.mongodb.net/?retryWrites=true&w=majority&appName=chess-training-cluster';
...
app.use(cors({
  origin: process.env.NODE_ENV === 'production' 
    ? [
        ...
        'https://newfrontend-vc32.onrender.com',
        'https://chess-ai-clone.onrender.com',
