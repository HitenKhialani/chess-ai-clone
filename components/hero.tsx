...
export default function Hero() {
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-[var(--card-foreground)]">
        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-8">
          ...
          >
            <div className="space-y-4">
              <Badge variant="secondary" className="w-fit bg-[var(--secondary)] text-purple-800">
            ...
            <div className="flex flex-col gap-4 sm:flex-row">
              <Link href="/play">
                <Button size="lg" className="bg-[var(--accent)] hover:bg-[var(--accent)] hover:opacity-80 text-[var(--card-foreground)] px-8 py-3">
            ...
            <div className="grid grid-cols-3 gap-6 pt-8">
              <div className="text-center">
                <div className="text-2xl font-bold text-[var(--card-foreground)]">3200+</div>
                <div className="text-sm text-purple-200">Stockfish Rating</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-[var(--card-foreground)]">20+</div>
                <div className="text-sm text-purple-200">GM Styles</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-[var(--card-foreground)]">10K+</div>
          ...
          >
            <Card className="w-full max-w-md bg-[var(--card)]/10 backdrop-blur-sm border-[#00F5D4]/30">
              <CardContent className="p-6">
                <div className="mb-4 text-center">
                  <h3 className="text-lg font-bold text-[var(--card-foreground)]">Live Analysis</h3>
                ...
                <div className="mt-4 space-y-2">
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <span className="text-[var(--card-foreground)] font-mono">Nf3</span>
                  </div>
                  <div className="flex items-center justify-between text-sm">
