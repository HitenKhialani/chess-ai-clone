    ...
    <div className="py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-2 text-3xl font-bold tracking-tight text-[var(--card-foreground)] sm:text-4xl">
            What Our Users Say
          </p>
        ...
        <div className="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-8 lg:mx-0 lg:mt-20 lg:max-w-none lg:grid-cols-3">
          {testimonials.map((testimonial) => (
            ...
            >
              <div className="flex items-center gap-x-4">
                ...
                <div>
                  <div className="flex items-center gap-x-2">
                    <h3 className="text-lg font-bold leading-6 text-[var(--card-foreground)]">
                      {testimonial.name}
                    </h3>
                    <div className="text-sm text-[#4f46e5]">{testimonial.rating}</div>
                  </div>
                  <p className="text-sm leading-6 text-[var(--muted-foreground)]">{testimonial.role}</p>
                </div>
              </div>
              ...
              <blockquote className="mt-6 text-base leading-6 tracking-wide text-[var(--muted-foreground)]">
                {testimonial.content}
              </blockquote>
            </div>
          ))}
