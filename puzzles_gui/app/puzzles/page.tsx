...
const puzzleCategories = [
      { id: "tactics", name: "Tactics Trainer", icon: Target, color: "bg-[#00F5D4]" },
...
export default function PuzzlesPage() {
  ...
  return (
            <div className="min-h-screen bg-gradient-to-br from-[#0A1A2F] via-[#112B3C] to-[#1E3A5C]">
      {/* Header */}
              <div className="border-b border-[#00F5D4]/50 bg-black/20 backdrop-blur-sm">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-2">
                <Crown className="h-8 h-8 text-[#00F5D4]" />
                <span className="text-2xl font-bold text-white">Endgame</span>
              </div>
              <Badge variant="secondary" className="bg-[#00F5D4]/20 text-[#00F5D4]">
                Puzzles
              </Badge>
            </div>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-[#00F5D4] mb-6">Master chess with AI-powered puzzle training</p>
                ...
                <Card
                  ...
                  className={`cursor-pointer transition-all duration-200 hover:scale-105 ${
                    activeCategory === category.id
                      ? "ring-2 ring-[#00F5D4] bg-[#00F5D4]/20"
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            <Card className="bg-black/30 border-[#00F5D4]/50">
              <CardHeader>
                <div className="flex items-center justify-between">
                  <CardTitle className="text-white flex items-center space-x-2">
                    <Target className="h-5 w-5 text-[#00F5D4]" />
              ...
              <CardContent>
                {isLoading ? (
                  <div className="aspect-square bg-[#00F5D4]/10 rounded-lg flex items-center justify-center">
                    <div className="text-center">
                      <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-[#00F5D4] mx-auto mb-4"></div>
                      <p className="text-[#00F5D4]">Generating puzzle with Stockfish...</p>
                    </div>
                  </div>
                ) : currentPuzzle ? (
                  <ChessBoard
                    ...
                    onSolved={(correct, time) => handlePuzzleSolved(correct, time)}
                  />
                ) : null}
              </CardContent>
            </Card>
            ...
            {currentPuzzle && (
              <Card className="bg-black/30 border-[#00F5D4]/50">
                ...
                <CardContent className="space-y-4">
                  <div>
                    <p className="text-[#00F5D4] mb-2">{currentPuzzle.description}</p>
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between text-sm">
                      <span className="text-[#00F5D4]">Your Rating</span>
                      <span className="text-white font-medium">{userRating}</span>
                    </div>
                    <div className="flex justify-between text-sm">
                      <span className="text-[#00F5D4]">Current Streak</span>
            ...
            <Card className="bg-black/30 border-[#00F5D4]/50">
              ...
              <CardContent className="space-y-3">
                <Button
                  ...
                  className="w-full bg-[#00F5D4] hover:bg-[#00F5D4]/90"
                  disabled={isLoading}
                >
                  New Puzzle
                </Button>
                <Button
                  ...
                  variant="outline"
                  className="w-full border-[#00F5D4] text-[#00F5D4] hover:bg-[#00F5D4]/20"
                >
