    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-[#0A1A2F] via-[#112B3C] to-[#1E3A5C] p-8">
        <div className="container mx-auto max-w-2xl">
          <Button onClick={onBack} variant="ghost" className="mb-6 text-[#00F5D4] hover:text-white">
            ...
            <CardContent className="space-y-6">
              ...
              <div className="flex space-x-4">
                ...
                <Button
                  onClick={onBack}
                  variant="outline"
                  className="flex-1 border-[#00F5D4] text-[#00F5D4] hover:bg-[#00F5D4]/20"
                >
                  Back to Puzzles
                </Button>
              </div>
              ...
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  <div className="flex justify-between">
                    <span className="text-[#00F5D4]">Puzzles Solved</span>
                  ...
                  <div className="flex justify-between">
                    <span className="text-[#00F5D4]">Points per Solve</span>
